window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var zh = {
		  ...
		  "browse.sortByKey": "\u6309\u4E3B\u952E\u6392\u5E8F",
		  "browse.sortByIndex": "\u6309\u7D22\u5F15\u6392\u5E8F",
		  "browse.sortIndexNone": "\u4E0D\u6392\u5E8F",
		  "browse.sortAsc": "\u5347\u5E8F",
		  "browse.sortDesc": "\u964D\u5E8F",
		  "browse.sortTitle": "\u70B9\u51FB\u5207\u6362\u5347\u5E8F / \u964D\u5E8F",
		  "browse.actions": "\u64CD\u4F5C",
		  "browse.select": "\u9009\u4E2D",
		...
		var en = {
		  ...
		  "browse.sortByKey": "Sort by key",
		  "browse.sortByIndex": "Sort by index",
		  "browse.sortIndexNone": "No sort",
		  "browse.sortAsc": "Ascending",
		  "browse.sortDesc": "Descending",
		  "browse.sortTitle": "Click to switch ascending / descending",
		...
		function SqlBrowseTab(props) {
		  const { api, sourceId, schema, table, rows, query: query2, onQuery, onReload, onExport, onImport, onNotice, onError } = props;
		  ...
		  const activeSort = query2.orderByColumns === void 0 ? void 0 : sortOptions.find((option) => option.columns.join("\0") === query2.orderByColumns.join("\0"));
		    ...
		    for (const column of page?.columns ?? []) {
		          ...
		          React8.createElement(
		            ...
		            React8.createElement("input", {
		              ...
		              onKeyDown: (event) => {
		                ...
		                if (event.key === "Enter") {
		                  event.preventDefault();
		                  void saveCell(index, column.name, editing.value);
		                }
		              },
		      ...
		      cells.push(
		        React8.createElement(
		          ...
		          {
		            key: column.name,
		            className: `${isNull(value) ? "dbm-null" : ""}${canActOnRows ? " dbm-cell-editable" : ""}`.trim() || void 0,
		    ...
		    sortOptions.length === 0 ? null : [
		      ...
		      React8.createElement(
		        "select",
		        {
		          key: "sort",
		          className: "dbm-select",
		          value: activeSort === void 0 ? "" : activeSort.columns.join("\0"),
		          onChange: (event) => {
		            ...
		            onQuery({ page: 1, orderBy: void 0, orderByColumns: value.split("\0") });
		          }
		        },
		        [
		          React8.createElement("option", { key: "", value: "" }, t("browse.sortIndexNone")),
		          ...sortOptions.map((option) => React8.createElement("option", { key: option.label, value: option.columns.join("\0") }, option.label))
		        ]
		      ),
		      React8.createElement(
		        "button",
		        {
		          ...
		          type: "button",
		          className: "dbm-btn dbm-btn-sm",
		          disabled: activeSort === void 0,
		          title: t("browse.sortTitle"),
		          onClick: () => onQuery({ page: 1, orderDir: query2.orderDir === "asc" ? "desc" : "asc" })
		        },
		        query2.orderDir === "asc" ? t("browse.sortAsc") : t("browse.sortDesc")
		      )
		    ],
		...
		function fieldKind(column) {
		  if (column.options !== void 0 && column.options.length > 0) return { kind: "enum", options: column.options };
		...
		function isRowidAlias(kind, column) {
		      ...
		      rows.length === 0 ? React10.createElement("div", { className: "dbm-hint" }, t("search.noConditions")) : React10.createElement(
		        ...
		        ...rows.map((row, index) => {
		          ...
		          return React10.createElement(
		            ...
		            isUnary(row.operator) ? null : React10.createElement("input", {
		              className: "dbm-input",
		  ...
		  return React11.createElement(
		    ...
		    React11.createElement(
		      ...
		      React11.createElement(
		        ...
		        loading ? React11.createElement("span", { className: "dbm-hint" }, t("common.loading")) : null,
		        React11.createElement("button", { type: "button", className: "dbm-btn dbm-btn-sm", disabled: busy, onClick: () => {
		          onReload();
		          onReloadRows();
		        } }, t("common.refresh"))
		      ),
		...
		function ColumnEditor(props) {
		  ...
		  return React11.createElement(
		    ...
		    React11.createElement("strong", null, editor.mode === "add" ? t("structure.newColumn") : t("structure.editColumn", { column: editor.original })),
		    React11.createElement("label", { className: "dbm-hint" }, t("structure.colName")),
		    React11.createElement("input", {
		      className: "dbm-input",
		      value: spec.name,
		      style: { width: 120 },
		    ...
		    React11.createElement("label", { className: "dbm-hint" }, t("structure.col.type")),
		    React11.createElement(
		      "select",
		      {
		        className: "dbm-select",
		    ...
		    React11.createElement("label", { className: "dbm-hint" }, t("structure.col.default")),
		    React11.createElement("input", {
		      className: "dbm-input dbm-mono",
		    ...
		    editor.mode === "edit" && existing?.generated === true ? React11.createElement("span", { className: "dbm-hint" }, t("structure.generatedHint")) : null,
		    React11.createElement("span", { className: "dbm-spacer" }),
		    React11.createElement(
		      "button",
		      { type: "button", className: "dbm-btn dbm-btn-sm dbm-btn-primary", disabled: busy, onClick: onSubmit },
		      editor.mode === "add" ? t("structure.addSubmit") : t("structure.saveSubmit")
		    ),
		    React11.createElement("button", { type: "button", className: "dbm-btn dbm-btn-sm", disabled: busy, onClick: onCancel }, t("common.cancel"))
		  );
		}
		function IndexCreator(props) {
		  ...
		  return React11.createElement(
		    "div",
		    { className: "dbm-struct-editor" },
		    React11.createElement("strong", null, t("structure.addIndex")),
		    React11.createElement("label", { className: "dbm-hint" }, t("structure.indexName")),
		    React11.createElement("input", {
		      className: "dbm-input",
		      value: form.name,
		      style: { width: 150 },
		    ...
		    React11.createElement("span", { className: "dbm-hint" }, t("structure.indexColumnsHint")),
		    ...columns.map((column) => {
		      const at = form.columns.indexOf(column.name);
		      return React11.createElement(
		        "label",
		        { key: column.name, className: "dbm-check" },
		        React11.createElement("input", {
		          type: "checkbox",
		          checked: at !== -1,
		          onChange: (event) => {
		    ...
		    React11.createElement("span", { className: "dbm-spacer" }),
		    React11.createElement("button", { type: "button", className: "dbm-btn dbm-btn-sm dbm-btn-primary", disabled: busy, onClick: onSubmit }, t("structure.createIndex")),
		    React11.createElement("button", { type: "button", className: "dbm-btn dbm-btn-sm", disabled: busy, onClick: onCancel }, t("common.cancel"))
		  );
		}
		...
		function ExportDialog(props) {
		  ...
		  const [format, setFormat] = React12.useState(rowsOnly === true ? "csv" : "sql");
		  const [scope, setScope] = React12.useState(
		    hasSelection ? "selected" : rowsOnly === true ? "table" : "table"
		  );
		  const [includeStructure, setIncludeStructure] = React12.useState(true);
		  const [includeData, setIncludeData] = React12.useState(true);
		  const [drop, setDrop] = React12.useState(false);
		  const [busy, setBusy] = React12.useState(false);
		  const [result, setResult] = React12.useState(void 0);
		  React12.useEffect(() => {
		  ...
		  const run = async () => {
		    ...
		    try {
		      const payload = {
		        ...
		        format,
		        ...scope === "schema" || format === "csv" ? hasTable ? { tables: [table] } : {} : hasTable ? { tables: [table] } : {}
		      };
		  ...
		  const row = (label, control) => React12.createElement(
		    "div",
		    { className: "dbm-row" },
		    React12.createElement("span", { className: "dbm-hint", style: { width: 110, flex: "none" } }, label),
		    control
		  );
		  return React12.createElement(Modal, {
		    ...
		    onClose,
		    footer: [
		      React12.createElement("button", { key: "close", type: "button", className: "dbm-btn", disabled: busy, onClick: onClose }, t("common.close")),
		    ...
		    children: React12.createElement(
		      "div",
		      null,
		      row(t("export.format"), React12.createElement(
		        "select",
		        {
		          className: "dbm-select",
		          value: format,
		        ...
		        React12.createElement("option", { value: "sql" }, t("export.format.sql")),
		        React12.createElement("option", { value: "csv" }, t("export.format.csv"))
		      )),
		      format === "csv" ? null : row(
		        t("export.scope"),
		        React12.createElement(
		          ...
		          [
		            React12.createElement("option", { key: "schema", value: "schema" }, t("export.scope.schema", { n: tableCount })),
		            hasTable ? React12.createElement("option", { key: "table", value: "table" }, t("export.scope.table")) : null,
		            hasSelection ? React12.createElement("option", { key: "selected", value: "selected" }, t("export.scope.selected")) : null
		          ].filter((entry) => entry !== null)
		        )
		      ),
		      row("", React12.createElement(
		        "label",
		        { className: "dbm-check" },
		      ...
		      drop ? React12.createElement("div", { className: "dbm-hint" }, t("export.dropWarn")) : null,
		      result === void 0 ? null : React12.createElement(
		        "div",
		        { className: "dbm-ok" },
		        t("export.done", { name: result.filename, size: formatBytes(result.size) }),
		        result.truncated.length === 0 ? null : React12.createElement("div", { className: "dbm-hint" }, t("export.truncated", { n: result.truncated.length }))
		      ),
		      React12.createElement("div", { className: "dbm-hint" }, t("export.hint"))
		    )
		  });
		}
		function ImportDialog(props) {
		  const { api, source, schema, table, tables, onClose, onDone, onError } = props;
		  const [format, setFormat] = React12.useState("sql");
		  const [target, setTarget] = React12.useState(table ?? tables[0]?.name ?? "");
		  const [hasHeader, setHasHeader] = React12.useState(true);
		  const [emptyAsNull, setEmptyAsNull] = React12.useState(true);
		  const [file, setFile] = React12.useState(void 0);
		  const [busy, setBusy] = React12.useState(false);
		  const [result, setResult] = React12.useState(void 0);
		  const read = (chosen) => {
		  ...
		  return React12.createElement(Modal, {
		    ...
		    children: React12.createElement(
		      "div",
		      null,
		      row(t("import.format"), React12.createElement(
		        "select",
		        {
		          className: "dbm-select",
		          value: format,
		        ...
		        React12.createElement("option", { value: "sql" }, t("import.format.sql")),
		        React12.createElement("option", { value: "csv" }, t("import.format.csv"))
		      )),
		      format === "csv" ? [
		        row(t("import.table"), React12.createElement(
		          "select",
		          {
		            key: "target",
		            className: "dbm-select",
		          ...
		          tables.filter((entry) => entry.type !== "view").map((entry) => React12.createElement("option", { key: entry.name, value: entry.name }, entry.name))
		        )),
		        React12.createElement("div", { key: "hint", className: "dbm-hint" }, t("import.tableHint")),
		        row("", React12.createElement(
		          "label",
		        ...
		        hasHeader ? null : React12.createElement("div", { key: "hh", className: "dbm-hint" }, t("import.hasHeaderHint")),
		        row("", React12.createElement(
		          "label",
		        ...
		        React12.createElement("div", { key: "nh", className: "dbm-hint" }, t("import.emptyAsNullHint"))
		      ] : null,
		      row(t("import.file"), React12.createElement("input", {
		        type: "file",
		        className: "dbm-input",
		      ...
		      file === void 0 ? React12.createElement("div", { className: "dbm-hint" }, t("import.noFile")) : React12.createElement("div", { className: "dbm-hint" }, `${file.name} \xB7 ${formatBytes(file.size)}`),
		      React12.createElement("div", { className: "dbm-hint" }, t("import.warn")),
		      result === void 0 ? null : React12.createElement("div", { className: "dbm-ok" }, result),
		      React12.createElement("div", { className: "dbm-hint" }, t("import.hint"))
		    )
		  });
		}
		...
		function SqlDatabaseView(props) {
		  ...
		  const [schemas, setSchemas] = React13.useState(initialSchemas);
		  const [tableFilter, setTableFilter] = React13.useState("");
		  const [openSchemas, setOpenSchemas] = React13.useState({});
		  const [tablesBySchema, setTablesBySchema] = React13.useState({});
		  const [loadingSchemas, setLoadingSchemas] = React13.useState({});
		  const [activeSchema, setActiveSchema] = React13.useState(void 0);
		  const [activeTable, setActiveTable] = React13.useState(void 0);
		  const [tab, setTab] = React13.useState("browse");
		  const [error, setError] = React13.useState(void 0);
		  const [notice, setNotice] = React13.useState(void 0);
		  const [rows, setRows] = React13.useState(void 0);
		  const [browse, setBrowse] = React13.useState({ page: 1, pageSize: 200, orderDir: "asc" });
		  const [columns, setColumns] = React13.useState([]);
		  const [indexes, setIndexes] = React13.useState([]);
		  const [transfer, setTransfer] = React13.useState(void 0);
		  const [schemaTables, setSchemaTables] = React13.useState([]);
		  const [statsBySchema, setStatsBySchema] = React13.useState({});
		  const [statsLoading, setStatsLoading] = React13.useState(false);
		  const [confirming, setConfirming] = React13.useState(void 0);
		  const [acting, setActing] = React13.useState(false);
		  const loadSchemas = React13.useCallback(async () => {
		  ...
		  const loadTables = React13.useCallback(async (schema, force = false) => {
		  ...
		  const loadStats = React13.useCallback(async (schema, force = false) => {
		  ...
		  const loadRows = React13.useCallback(async (options) => {
		  ...
		  const loadStructure = React13.useCallback(async (schema, table) => {
		    try {
		  ...
		  const reloadCurrent = React13.useCallback(() => {
		  ...
		  for (const schema of schemas) {
		    ...
		    tree.push(
		      React13.createElement(
		        ...
		        React13.createElement("span", { className: "dbm-node-name" }, schema),
		        tables === void 0 ? null : React13.createElement("span", { className: "dbm-tree-meta" }, String(tables.filter((table) => matchesFilter(table.name)).length))
		      )
		    );
		    if (!isOpen) continue;
		    if (loading && tables === void 0) {
		      tree.push(React13.createElement("div", { key: `loading-${schema}`, className: "dbm-tree-item dbm-tree-indent-1 dbm-hint" }, t("common.loading")));
		      continue;
		    }
		    ...
		    for (const table of list) {
		      tree.push(
		        React13.createElement(
		          ...
		          React13.createElement("span", { className: "dbm-tree-caret" }, table.type === "view" ? "\u25EB" : "\u25A4"),
		          React13.createElement("span", { className: "dbm-tree-name" }, table.name),
		          table.rows === void 0 ? null : React13.createElement("span", { className: "dbm-tree-meta" }, String(table.rows))
		        )
		      );
		    }
		  }
		  const left = React13.createElement(
		    "div",
		    { className: "dbm-side" },
		    React13.createElement(
		      "div",
		    ...
		    React13.createElement("div", { className: "dbm-side-body" }, tree)
		  );
		  ...
		  if (activeSchema === void 0) {
		    body.push(React13.createElement(Empty, { key: "empty", message: t("db.selectSchema") }));
		  } else if (selection === void 0) {
		    body.push(
		      React13.createElement(TableOverview, {
		        key: "overview",
		        schema: activeSchema,
		    ...
		    body.push(
		      React13.createElement(TabStrip, {
		        key: "tabs",
		        active: tab,
		        tabs: [
		    ...
		    if (tab === "browse") {
		      body.push(React13.createElement(SqlBrowseTab, {
		        key: "browse-body",
		        api,
		        sourceId: source.id,
		    ...
		    if (tab === "structure") {
		      body.push(React13.createElement(SqlStructureTab, {
		        key: "structure-body",
		        api,
		        sourceId: source.id,
		        schema: selection.schema,
		    ...
		    if (tab === "sql") {
		      body.push(
		        React13.createElement(SqlTabView, {
		          key: "sql-body",
		          source,
		          schema: activeSchema,
		          api,
		    ...
		    if (tab === "search") {
		      body.push(
		        React13.createElement(SqlSearchTab, {
		          key: "search-body",
		          columns,
		    ...
		    if (tab === "insert") {
		      body.push(
		        React13.createElement(SqlInsertTab, {
		          key: "insert-body",
		          api,
		          source,
		          schema: selection.schema,
		  ...
		  return React13.createElement(
		    ...
		    React13.createElement(
		      "div",
		      { className: "dbm-header" },
		      React13.createElement(BackButton, { onBack, label: t("panel.backToList") }),
		      React13.createElement("span", { className: "dbm-title" }, source.name),
		      React13.createElement("span", { className: `dbm-badge dbm-badge-${source.kind}` }, source.kind),
		      React13.createElement("span", { className: "dbm-subtitle dbm-mono" }, source.kind === "sqlite" ? source.file ?? "" : `${source.host ?? ""}:${source.port ?? ""}`),
		      React13.createElement("span", { className: "dbm-spacer" }),
		      React13.createElement(BackButton, { onBack: onClose })
		    ),
		    error === void 0 ? null : React13.createElement(ErrorBanner, { message: error }),
		    notice === void 0 ? null : React13.createElement("div", { className: "dbm-ok", style: { padding: "6px 14px" } }, notice),
		    React13.createElement("div", { className: "dbm-split" }, left, React13.createElement("div", { className: "dbm-main" }, body)),
		    confirming === void 0 ? null : React13.createElement(TableActionDialog, {
		      key: "confirm",
		      state: confirming,
		      busy: acting,
		      onCancel: () => setConfirming(void 0),
		      onConfirm: () => {
		        void runTableAction(confirming.schema, confirming.table, confirming.op);
		      }
		    }),
		    transfer === void 0 ? null : transfer.kind === "export" ? React13.createElement(ExportDialog, {
		      key: "export",
		      api,
		      source,
		      schema: activeSchema ?? "",
		    ...
		    }) : React13.createElement(ImportDialog, {
		      key: "import",
		      api,
		      source,
		      schema: activeSchema ?? "",
		...
		function TableActionDialog(props) {
		  ...
		  const body = truncate ? isView ? t("db.truncate.bodyView", { table: state.table.name }) : t("db.truncate.body", { table: state.table.name }) : isView ? t("db.drop.bodyView", { table: state.table.name }) : t("db.drop.body", { table: state.table.name });
		  return React13.createElement(Modal, {
		    title: t(truncate ? "db.truncate.title" : "db.drop.title"),
		    onClose: onCancel,
		    footer: [
		      React13.createElement("button", { key: "cancel", type: "button", className: "dbm-btn", disabled: busy, onClick: onCancel }, t("common.cancel")),
		      React13.createElement(
		        "button",
		        {
		          key: "ok",
		    ...
		    children: React13.createElement("div", null, body)
		  });
		}
		function TableOverview(props) {
		  ...
		  if (tables === void 0) {
		    return React13.createElement(
		      "div",
		      { className: "dbm-tab-body" },
		      React13.createElement("div", { className: "dbm-pad dbm-hint" }, t("db.loadingStats"))
		    );
		  }
		  const needle = filter.trim().toLowerCase();
		  const list = needle === "" ? tables : tables.filter((table) => table.name.toLowerCase().includes(needle));
		  const action = (key, label, onClick, danger = false) => React13.createElement(
		    "button",
		    {
		      key,
		      type: "button",
		  ...
		  return React13.createElement(
		    ...
		    React13.createElement(
		      ...
		      React13.createElement("span", { className: "dbm-hint" }, t("db.filterPlaceholder")),
		      React13.createElement("input", {
		        className: "dbm-input",
		        value: filter,
		      ...
		      React13.createElement("span", { className: "dbm-hint" }, t("db.overviewFor", { schema, n: tables.length })),
		      React13.createElement("span", { className: "dbm-spacer" }),
		      loading ? React13.createElement("span", { className: "dbm-hint" }, t("common.loading")) : null,
		      React13.createElement("button", { type: "button", className: "dbm-btn dbm-btn-sm", onClick: onRefresh }, t("common.refresh"))
		    ),
		    list.length === 0 ? React13.createElement(Empty, { message: tables.length === 0 ? t("db.overviewEmpty") : t("list.emptyFiltered") }) : React13.createElement(
		      "div",
		      { className: "dbm-scroll" },
		      React13.createElement(
		        "table",
		        ...
		        React13.createElement(
		          ...
		          React13.createElement(
		            ...
		            ...[t("db.col.table"), t("db.col.actions"), t("db.col.rows"), t("db.col.type"), t("db.col.collation"), t("db.col.size"), t("db.col.comment")].map(
		              (label) => React13.createElement("th", { key: label }, label)
		            )
		          )
		        ),
		        React13.createElement(
		          ...
		          list.map(
		            (table) => React13.createElement(
		                ...
		                React13.createElement(
		                  ...
		                  React13.createElement(
		                    "button",
		                    {
		                      ...
		                      title: table.type === "view" ? t("db.truncate.bodyView", { table: table.name }) : void 0,
		              ...
		              React13.createElement(
		                "td",
		                { className: "dbm-mono" },
		                table.rows === void 0 ? React13.createElement("span", { className: "dbm-hint", title: t("db.rowsUnknown.hint") }, t("db.rowsUnknown")) : table.rows.toLocaleString()
		              ),
		              React13.createElement(
		                "td",
		                null,
		              ...
		              React13.createElement("td", { className: "dbm-mono" }, table.collation ?? t("common.none")),
		              React13.createElement("td", { className: "dbm-mono" }, formatBytes(table.size)),
		              React13.createElement("td", { title: table.comment ?? "" }, table.comment ?? "")
		            )
		          )
		        )
		      )
		...
		function SqlTabView(props) {
		  ...
		  const [sql, setSql] = React13.useState("");
		  const [allowWrite, setAllowWrite] = React13.useState(false);
		  ...
		  return React13.createElement(
		    ...
		    React13.createElement(
		      ...
		      React13.createElement(
		        "div",
		        { className: "dbm-row" },
		        React13.createElement("button", { type: "button", className: "dbm-btn dbm-btn-primary", disabled: busy, onClick: () => {
		          void run();
		        ...
		        React13.createElement("span", { className: "dbm-hint" }, t("sql.allowWrite.hint"))
		      )
		    ),
		    result === void 0 ? null : React13.createElement(
		      "div",
		      { className: "dbm-tab-body", style: { minHeight: 0 } },
		      React13.createElement("div", { className: "dbm-pad dbm-hint" }, result.message),
		      result.columns.length === 0 ? null : React13.createElement(
		        "div",
		        { className: "dbm-data" },
		        React13.createElement(
		          "table",
		          null,
		          React13.createElement("thead", null, React13.createElement("tr", null, result.columns.map((column) => React13.createElement("th", { key: column }, column)))),
		          React13.createElement(
		            "tbody",
		            null,
		            result.rows.map(
		              (row, index) => React13.createElement(
		                "tr",
		                { key: index },
		                row.map(
		                  (cell, cellIndex) => React13.createElement(
		                    "td",
		                    { key: cellIndex, className: isNull(cell) ? "dbm-null" : void 0, title: renderCell(cell) },
		                    renderCell(cell)
		                  )
		...
		function DatabasePanel(props) {
		  ...
		  const [snapshot, setSnapshot] = React14.useState(() => controller.getSnapshot());
		  const [sources, setSources] = React14.useState(void 0);
		  const [settings, setSettings] = React14.useState({ allowAgentWrite: false, requireApproval: true });
		  const [engines, setEngines] = React14.useState([]);
		  const [error, setError] = React14.useState(void 0);
		  void localeTick;
		  React14.useEffect(() => controller.subscribe(() => setSnapshot(controller.getSnapshot())), [controller]);
		  const reload = React14.useCallback(async () => {
		    try {
		  ...
		  const saveGate = React14.useCallback(async (patch) => {
		    try {
		  ...
		  const connect = React14.useCallback(async (source) => {
		    try {
		  ...
		  let body;
		  if (screen.name === "sql") {
		    body = React14.createElement(SqlDatabaseView, {
		      api,
		    ...
		    body = React14.createElement(RedisDatabaseView, {
		      api,
		      source: screen.source,
		    ...
		    body = React14.createElement(Empty, { message: t("common.loading") });
		  } else {
		    body = React14.createElement(SourceListView, {
		      api,
		      sources,
		      settings,
		      engines,
		    ...
		    try {
		      return container.inject(
		        ...
		        () => container.register(
		          ...
		          (props) => React15.createElement("span", {
		    ...
		    try {
		      return container.inject(
		        ...
		        () => container.register(
		          ...
		          () => React15.createElement(PanelHost, { controller, api, localeListeners, onClose: close })
		        )
		      );
		    } catch (failure) {
		...
		function PanelHost(props) {
		  ...
		  const [localeTick, setLocaleTick] = React15.useState(0);
		  React15.useEffect(() => {
		  ...
		  return React15.createElement(DatabasePanel, { controller, api, localeTick, onClose });
		}
