window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function RedisDatabaseView(props) {
		  ...
		  return React2.createElement(
		    ...
		    React2.createElement(
		      ...
		      React2.createElement("button", { type: "button", className: "dbm-btn dbm-btn-sm", onClick: onBack }, `\u2190 ${t("panel.close")}`),
		...
		function SqlDatabaseView(props) {
		  ...
		  return React5.createElement(
		    ...
		    React5.createElement(
		      "div",
		      { className: "dbm-header" },
		      React5.createElement("button", { type: "button", className: "dbm-btn dbm-btn-sm", onClick: onBack }, `\u2190 ${t("panel.close")}`),
		...
		function DatabasePanel(props) {
		  ...
		  return React6.createElement("div", { className: "dbm-root" }, error === void 0 ? null : React6.createElement(ErrorBanner, { message: error }), body);
		}
		    ...
		    try {
		      return container.inject(
		        ...
		        () => container.register(
		          ...
		          () => React7.createElement(PanelHost, { controller, api, localeListeners })
		        )
		      );
		    } catch (failure) {
		...
		function PanelHost(props) {
		  ...
		  return React7.createElement(DatabasePanel, { controller, api, localeTick });
		}
