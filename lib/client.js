window.__ModuleLoader__.load({
	...
	factory: (require) => {
		    ...
		    React2.createElement(
		      ...
		      React2.createElement(
		        ...
		        Array.from({ length: 16 }, (_, index) => index).map((index) => {
		          ...
		          const suffix = keysInDb === void 0 ? "" : ` \xB7 ${keysInDb} keys`;
		          return React2.createElement("option", { key: index, value: String(index) }, `db${index}${suffix}`);
		        })
		      )
		    ),
		    React2.createElement(
		...
		function SourceFormDialog(props) {
		  ...
		  const [testResult, setTestResult] = React3.useState(void 0);
		  const patch = (next) => {
		  ...
		  if (state.kind === "sqlite") {
		    ...
		    if (state.kind === "mysql") {
		      children.push(React3.createElement("div", { className: "dbm-hint", key: "schemaless-hint" }, t("form.mysql.noDefaultSchema")));
		    }
		    children.push(
		      field(
		        t("form.password"),
		    ...
		    children.push(React3.createElement("div", { className: "dbm-hint", key: "tls-hint" }, t("form.tls.hint")));
		    children.push(
		      React3.createElement(
		        "div",
		        { className: "dbm-field-inline", key: "timeout" },
		        React3.createElement("span", null, t("form.timeout")),
		        React3.createElement("input", {
		          className: "dbm-input",
		        ...
		        React3.createElement("span", { className: "dbm-hint" }, t("form.timeout.unit"))
		      )
		    );
		  }
		  children.push(
		  ...
		  if (testResult !== void 0) {
		    children.push(
		      testResult.ok ? React3.createElement(
		        "div",
		        { className: "dbm-ok", key: "test-ok" },
		        t("form.test.ok", { ms: testResult.latencyMs ?? 0, version: testResult.serverVersion ?? "" }).trim(),
		        testResult.note === void 0 ? null : React3.createElement("div", { className: "dbm-hint" }, t("form.test.note", { note: testResult.note }))
		      ) : React3.createElement(ErrorBanner, { key: "test-fail", message: t("test.fail", { error: testResult.error ?? "" }) })
		    );
		  }
		  ...
		  return React3.createElement(Modal, {
		    ...
		    footer: React3.createElement(
		      ...
		      React3.createElement(
		        ...
		        onTest === void 0 ? null : React3.createElement(
		          "button",
		          {
		            key: "test",
		            type: "button",
		      ...
		      React3.createElement(
		        ...
		        React3.createElement("button", { key: "cancel", type: "button", className: "dbm-btn", disabled: footerBusy, onClick: onClose }, t("form.cancel")),
		        React3.createElement("button", { key: "save", type: "button", className: "dbm-btn dbm-btn-primary", disabled: footerBusy, onClick: () => {
		          void submit();
		...
		function SqlDatabaseView(props) {
		  ...
		  const [openSchemas, setOpenSchemas] = React5.useState({});
		  const [tablesBySchema, setTablesBySchema] = React5.useState({});
		  const [loadingSchemas, setLoadingSchemas] = React5.useState({});
		  const [activeSchema, setActiveSchema] = React5.useState(void 0);
		  ...
		  const loadTables = React5.useCallback(async (schema, force = false) => {
		  ...
		  const loadStructure = React5.useCallback(async (schema, table) => {
		    try {
		  ...
		  for (const schema of schemas) {
		    ...
		    tree.push(
		      React5.createElement(
		        ...
		        React5.createElement("span", { className: "dbm-tree-name" }, schema),
		        tables === void 0 ? null : React5.createElement("span", { className: "dbm-tree-meta" }, String(tables.filter((table) => matchesFilter(table.name)).length))
		      )
		    );
		    if (!isOpen) continue;
		    if (loading && tables === void 0) {
		      tree.push(React5.createElement("div", { key: `loading-${schema}`, className: "dbm-tree-item dbm-tree-indent-1 dbm-hint" }, t("common.loading")));
		      continue;
		    }
		  ...
		  const body = [];
		  if (selection === void 0) {
		    body.push(React5.createElement(Empty, { key: "empty", message: t("db.selectTable") }));
		  } else {
		    body.push(
