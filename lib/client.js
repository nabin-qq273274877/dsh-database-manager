window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function SqlSearchTab(props) {
		  ...
		  const nextId = React11.useRef(1);
		  const [rows, setRows] = React11.useState([]);
		  const [localJoin, setLocalJoin] = React11.useState(join);
		  ...
		  return React11.createElement(
		    ...
		    React11.createElement(
		      "div",
		      { className: "dbm-pad" },
		      React11.createElement("div", { className: "dbm-hint" }, t("search.join")),
		      React11.createElement(
		        "select",
		        {
		          className: "dbm-select",
		        ...
		        React11.createElement("option", { value: "and" }, t("search.join.and")),
		        React11.createElement("option", { value: "or" }, t("search.join.or"))
		      ),
		      rows.length === 0 ? React11.createElement("div", { className: "dbm-hint" }, t("search.noConditions")) : React11.createElement(
		        "div",
		        ...
		        ...rows.map((row, index) => {
		          ...
		          return React11.createElement(
		            ...
		            React11.createElement(
		              ...
		              columns.map((candidate) => React11.createElement(
		                "option",
		            ...
		            isUnaryOperator(row.operator) ? null : React11.createElement("input", {
		              className: "dbm-input",
		      ...
		      React11.createElement(
		        "div",
		        { className: "dbm-row" },
		        React11.createElement("button", { type: "button", className: "dbm-btn dbm-btn-sm", onClick: addRow }, `+ ${t("search.addCondition")}`),
		        React11.createElement("button", {
		          type: "button",
		          className: "dbm-btn dbm-btn-sm dbm-btn-primary",
		    ...
		    results === void 0 ? null : React11.createElement("div", { className: "dbm-tab-body", style: { minHeight: 0 } }, results)
		  );
		}
		...
		function ColumnEditor(props) {
		  ...
		  return React12.createElement(Modal, {
		    ...
		    children: React12.createElement(
		      ...
		      field("default", t("structure.col.default"), React12.createElement("input", {
		        className: "dbm-input dbm-mono",
