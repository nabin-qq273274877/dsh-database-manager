window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function SqlDatabaseView(props) {
		  ...
		  const [statsBySchema, setStatsBySchema] = React8.useState({});
		  const [statsLoading, setStatsLoading] = React8.useState(false);
		  const [confirming, setConfirming] = React8.useState(void 0);
		  const [acting, setActing] = React8.useState(false);
		  ...
		  const loadStats = React8.useCallback(async (schema, force = false) => {
		  ...
		  const selectSchema = (schema) => {
		    if (activeSchema !== schema) setActiveTable(void 0);
		  ...
		  for (const schema of schemas) {
		    ...
		    tree.push(
		      React8.createElement(
		        ...
		        React8.createElement("span", { className: "dbm-node-name" }, schema),
		  ...
		  if (activeSchema === void 0) {
		    body.push(React8.createElement(Empty, { key: "empty", message: t("db.selectSchema") }));
		  } else if (selection === void 0) {
		    body.push(
		      React8.createElement(TableOverview, {
		        key: "overview",
		        schema: activeSchema,
		  ...
		  return React8.createElement(
		    ...
		    confirming === void 0 ? null : React8.createElement(TableActionDialog, {
		      key: "confirm",
		      state: confirming,
		      busy: acting,
		...
		function TableActionDialog(props) {
		  ...
		  return React8.createElement(Modal, {
		    title: t(truncate ? "db.truncate.title" : "db.drop.title"),
		    onClose: onCancel,
		    footer: [
		      React8.createElement("button", { key: "cancel", type: "button", className: "dbm-btn", disabled: busy, onClick: onCancel }, t("common.cancel")),
		      React8.createElement(
		        "button",
		        {
		          key: "ok",
		    ...
		    children: React8.createElement("div", null, body)
		  });
		}
		function TableOverview(props) {
		  ...
		  if (tables === void 0) {
		    return React8.createElement(
		      "div",
		      { className: "dbm-tab-body" },
		      React8.createElement("div", { className: "dbm-pad dbm-hint" }, t("db.loadingStats"))
		    );
		  }
		  const needle = filter.trim().toLowerCase();
		  const list = needle === "" ? tables : tables.filter((table) => table.name.toLowerCase().includes(needle));
		  const action = (key, label, onClick, danger = false) => React8.createElement(
		    "button",
		    {
		      key,
		      type: "button",
		  ...
		  return React8.createElement(
		    ...
		    React8.createElement(
		      ...
		      React8.createElement("span", { className: "dbm-hint" }, t("db.filterPlaceholder")),
		      React8.createElement("input", {
		        className: "dbm-input",
		        value: filter,
		      ...
		      React8.createElement("span", { className: "dbm-hint" }, t("db.overviewFor", { schema, n: tables.length })),
		      React8.createElement("span", { className: "dbm-spacer" }),
		      loading ? React8.createElement("span", { className: "dbm-hint" }, t("common.loading")) : null,
		      React8.createElement("button", { type: "button", className: "dbm-btn dbm-btn-sm", onClick: onRefresh }, t("common.refresh"))
		    ),
		    list.length === 0 ? React8.createElement(Empty, { message: tables.length === 0 ? t("db.overviewEmpty") : t("list.emptyFiltered") }) : React8.createElement(
		      "div",
		      { className: "dbm-scroll" },
		      React8.createElement(
		        "table",
		          ...
		          list.map(
		            (table) => React8.createElement(
		              ...
		              React8.createElement(
		                "td",
		                { className: "dbm-mono" },
		                table.rows === void 0 ? React8.createElement("span", { className: "dbm-hint", title: t("db.rowsUnknown.hint") }, t("db.rowsUnknown")) : table.rows.toLocaleString()
		              ),
		              React8.createElement(
		                "td",
		                null,
		              ...
		              React8.createElement("td", { className: "dbm-mono" }, table.collation ?? t("common.none")),
		              React8.createElement("td", { className: "dbm-mono" }, formatBytes(table.size)),
		              React8.createElement("td", { title: table.comment ?? "" }, table.comment ?? "")
		            )
		          )
		        )
		      )
