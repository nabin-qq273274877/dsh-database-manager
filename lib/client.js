window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function ExportDialog(props) {
		  ...
		  const [format, setFormat] = React13.useState(rowsOnly === true ? "csv" : "sql");
		  const [scope, setScope] = React13.useState(
		    hasSelection ? "selected" : rowsOnly === true ? "table" : "table"
		  );
		  const [includeStructure, setIncludeStructure] = React13.useState(true);
		  const [includeData, setIncludeData] = React13.useState(true);
		  const [drop, setDrop] = React13.useState(false);
		  const [busy, setBusy] = React13.useState(false);
		  const [result, setResult] = React13.useState(void 0);
		  React13.useEffect(() => {
		  ...
		  const row = (label, control) => React13.createElement(
		    "div",
		    { className: "dbm-row" },
		    React13.createElement("span", { className: "dbm-hint", style: { width: 110, flex: "none" } }, label),
		    control
		  );
		  return React13.createElement(Modal, {
		    ...
		    onClose,
		    footer: [
		      React13.createElement("button", { key: "close", type: "button", className: "dbm-btn", disabled: busy, onClick: onClose }, t("common.close")),
		    ...
		    children: React13.createElement(
		      "div",
		      null,
		      row(t("export.format"), React13.createElement(
		        "select",
		        {
		          className: "dbm-select",
		          value: format,
		        ...
		        React13.createElement("option", { value: "sql" }, t("export.format.sql")),
		        React13.createElement("option", { value: "csv" }, t("export.format.csv"))
		      )),
		      format === "csv" ? null : row(
		        t("export.scope"),
		        React13.createElement(
		          ...
		          [
		            React13.createElement("option", { key: "schema", value: "schema" }, t("export.scope.schema", { n: tableCount })),
		            hasTable ? React13.createElement("option", { key: "table", value: "table" }, t("export.scope.table")) : null,
		            hasSelection ? React13.createElement("option", { key: "selected", value: "selected" }, t("export.scope.selected")) : null
		          ].filter((entry) => entry !== null)
		        )
		      ),
		      presetTables !== void 0 && presetTables.length > 0 ? React13.createElement(
		        "div",
		      ...
		      drop ? React13.createElement("div", { className: "dbm-hint" }, t("export.dropWarn")) : null,
		      result === void 0 ? null : React13.createElement(
		        "div",
		        { className: "dbm-ok" },
		        t("export.done", { name: result.filename, size: formatBytes(result.size) }),
		        result.truncated.length === 0 ? null : React13.createElement("div", { className: "dbm-hint" }, t("export.truncated", { n: result.truncated.length }))
		      ),
		      React13.createElement("div", { className: "dbm-hint" }, t("export.hint"))
		    )
		  });
		}
		function ImportDialog(props) {
		  const { api, source, schema, table, tables, onClose, onDone, onError } = props;
		  const [format, setFormat] = React13.useState("sql");
		  const [target, setTarget] = React13.useState(table ?? tables[0]?.name ?? "");
		  const [hasHeader, setHasHeader] = React13.useState(true);
		  const [emptyAsNull, setEmptyAsNull] = React13.useState(true);
		  const [file, setFile] = React13.useState(void 0);
		  const [busy, setBusy] = React13.useState(false);
		  const [result, setResult] = React13.useState(void 0);
		  const read = (chosen) => {
		  ...
		  return React13.createElement(Modal, {
		    ...
		    children: React13.createElement(
		      "div",
		      null,
		      row(t("import.format"), React13.createElement(
		        "select",
		        {
		          className: "dbm-select",
		          value: format,
		        ...
		        React13.createElement("option", { value: "sql" }, t("import.format.sql")),
		        React13.createElement("option", { value: "csv" }, t("import.format.csv"))
		      )),
		      format === "csv" ? [
		        row(t("import.table"), React13.createElement(
		          "select",
		          {
		            key: "target",
		            className: "dbm-select",
		          ...
		          tables.filter((entry) => entry.type !== "view").map((entry) => React13.createElement("option", { key: entry.name, value: entry.name }, entry.name))
		        )),
		        React13.createElement("div", { key: "hint", className: "dbm-hint" }, t("import.tableHint")),
		        row("", React13.createElement(
		          "label",
		        ...
		        hasHeader ? null : React13.createElement("div", { key: "hh", className: "dbm-hint" }, t("import.hasHeaderHint")),
		        row("", React13.createElement(
		          "label",
		        ...
		        React13.createElement("div", { key: "nh", className: "dbm-hint" }, t("import.emptyAsNullHint"))
		      ] : null,
		      row(t("import.file"), React13.createElement("input", {
		        type: "file",
		        className: "dbm-input",
		      ...
		      file === void 0 ? React13.createElement("div", { className: "dbm-hint" }, t("import.noFile")) : React13.createElement("div", { className: "dbm-hint" }, `${file.name} \xB7 ${formatBytes(file.size)}`),
		      React13.createElement("div", { className: "dbm-hint" }, t("import.warn")),
		      result === void 0 ? null : React13.createElement("div", { className: "dbm-ok" }, result),
		      React13.createElement("div", { className: "dbm-hint" }, t("import.hint"))
		    )
		  });
		}
		...
		function SqlDatabaseView(props) {
		  ...
		  const [schemas, setSchemas] = React14.useState(initialSchemas);
		  const [tableFilter, setTableFilter] = React14.useState("");
		  const [openSchemas, setOpenSchemas] = React14.useState({});
		  const [tablesBySchema, setTablesBySchema] = React14.useState({});
		  const [loadingSchemas, setLoadingSchemas] = React14.useState({});
		  const [activeSchema, setActiveSchema] = React14.useState(void 0);
		  const [activeTable, setActiveTable] = React14.useState(void 0);
		  const [tab, setTab] = React14.useState("browse");
		  const [error, setError] = React14.useState(void 0);
		  const [notice, setNotice] = React14.useState(void 0);
		  const [rows, setRows] = React14.useState(void 0);
		  const [browse, setBrowse] = React14.useState({ page: 1, pageSize: 200, orderDir: "asc" });
		  const [columns, setColumns] = React14.useState([]);
		  const [indexes, setIndexes] = React14.useState([]);
		  const [structureLoading, setStructureLoading] = React14.useState(false);
		  const [transfer, setTransfer] = React14.useState(void 0);
		  const [schemaTables, setSchemaTables] = React14.useState([]);
		  const [selectedTables, setSelectedTables] = React14.useState(/* @__PURE__ */ new Set());
		  const [maintenanceSupport, setMaintenanceSupport] = React14.useState([]);
		  const [maintenance, setMaintenance] = React14.useState(void 0);
		  const [databaseAction, setDatabaseAction] = React14.useState(void 0);
		  const [batchBusy, setBatchBusy] = React14.useState(false);
		  const [statsBySchema, setStatsBySchema] = React14.useState({});
		  const [statsLoading, setStatsLoading] = React14.useState(false);
		  const [confirming, setConfirming] = React14.useState(void 0);
		  const [acting, setActing] = React14.useState(false);
		  const loadSchemas = React14.useCallback(async () => {
		  ...
		  const loadTables = React14.useCallback(async (schema, force = false) => {
		  ...
		  const loadStats = React14.useCallback(async (schema, force = false) => {
		    if (!force && statsBySchema[schema] !== void 0) return;
		  ...
		  const reloadAfterDatabaseOp = async () => {
		    await loadSchemas();
		    setActiveTable(void 0);
		    setStatsBySchema({});
		    setSelectedTables(/* @__PURE__ */ new Set());
		  };
		  const loadRows = React14.useCallback(async (options) => {
		  ...
		  const loadStructure = React14.useCallback(async (schema, table) => {
		  ...
		  const reloadCurrent = React14.useCallback(() => {
		  ...
		  for (const schema of schemas) {
		    ...
		    tree.push(
		      React14.createElement(
		        ...
		        React14.createElement("span", { className: "dbm-node-name" }, schema),
		        /*
		         ...
		         */
		        tables === void 0 ? null : React14.createElement("span", { className: "dbm-tree-meta" }, String(tables.length))
		      )
		    );
		    if (!isOpen) continue;
		    if (loading && tables === void 0) {
		      tree.push(React14.createElement("div", { key: `loading-${schema}`, className: "dbm-tree-item dbm-tree-indent-1 dbm-hint" }, t("common.loading")));
		      continue;
		    }
		    ...
		    for (const table of list) {
		      tree.push(
		        React14.createElement(
		          ...
		          React14.createElement("span", { className: "dbm-tree-caret" }, table.type === "view" ? "\u25EB" : "\u25A4"),
		          React14.createElement("span", { className: "dbm-tree-name" }, table.name),
		          table.rows === void 0 ? null : React14.createElement("span", { className: "dbm-tree-meta" }, String(table.rows))
		        )
		      );
		    }
		  }
		  const [sideRefreshing, setSideRefreshing] = React14.useState(false);
		  const refreshSide = React14.useCallback(async () => {
		  ...
		  const left = React14.createElement(
		    "div",
		    { className: "dbm-side" },
		    React14.createElement(
		      "div",
		       ...
		       */
		      source.kind === "mysql" ? React14.createElement("button", {
		        type: "button",
		        className: "dbm-btn dbm-btn-sm",
		      ...
		      React14.createElement(
		        ...
		        sideRefreshing ? React14.createElement("span", { className: "dbm-spinner" }) : "\u27F3"
		      )
		    ),
		    React14.createElement("div", { className: "dbm-side-body" }, tree)
		  );
		  ...
		  if (activeSchema === void 0) {
		    body.push(React14.createElement(Empty, { key: "empty", message: t("db.selectSchema") }));
		  } else if (selection === void 0) {
		    body.push(
		      React14.createElement(TableOverview, {
		        key: "overview",
		        schema: activeSchema,
		    ...
		    body.push(
		      React14.createElement(TabStrip, {
		        key: "tabs",
		        active: tab,
		        tabs: [
		    ...
		    if (tab === "browse") {
		      body.push(React14.createElement(SqlBrowseTab, {
		        key: "browse-body",
		        api,
		        sourceId: source.id,
		    ...
		    if (tab === "structure") {
		      body.push(React14.createElement(SqlStructureTab, {
		        key: "structure-body",
		        api,
		        sourceId: source.id,
		        schema: selection.schema,
		    ...
		    if (tab === "sql") {
		      body.push(
		        React14.createElement(SqlTabView, {
		          key: "sql-body",
		          source,
		          schema: activeSchema,
		          api,
		    ...
		    if (tab === "search") {
		      body.push(
		        React14.createElement(SqlSearchTab, {
		          key: "search-body",
		          columns,
		           ...
		           */
		          results: React14.createElement(SqlBrowseTab, {
		            key: "search-results",
		            api,
		            sourceId: source.id,
		            schema: selection.schema,
		    ...
		    if (tab === "insert") {
		      body.push(
		        React14.createElement(SqlInsertTab, {
		          key: "insert-body",
		          api,
		          source,
		          schema: selection.schema,
		  ...
		  return React14.createElement(
		    ...
		    React14.createElement(
		      "div",
		      { className: "dbm-header" },
		      React14.createElement(BackButton, { onBack, label: t("panel.backToList") }),
		      React14.createElement("span", { className: "dbm-title" }, source.name),
		      React14.createElement("span", { className: `dbm-badge dbm-badge-${source.kind}` }, source.kind),
		      React14.createElement("span", { className: "dbm-subtitle dbm-mono" }, source.kind === "sqlite" ? source.file ?? "" : `${source.host ?? ""}:${source.port ?? ""}`),
		      React14.createElement("span", { className: "dbm-spacer" }),
		      React14.createElement(BackButton, { onBack: onClose })
		    ),
		    error === void 0 ? null : React14.createElement(ErrorBanner, { message: error }),
		    notice === void 0 ? null : React14.createElement("div", { className: "dbm-ok", style: { padding: "6px 14px" } }, notice),
		    React14.createElement("div", { className: "dbm-split" }, left, React14.createElement("div", { className: "dbm-main" }, body)),
		    confirming === void 0 ? null : React14.createElement(TableActionDialog, {
		      key: "confirm",
		      state: confirming,
		    ...
		    transfer === void 0 ? null : transfer.kind === "export" ? React14.createElement(ExportDialog, {
		      key: "export",
		      api,
		      source,
		      schema: activeSchema ?? "",
		    ...
		    }) : React14.createElement(ImportDialog, {
		      key: "import",
		      api,
		      source,
		      schema: activeSchema ?? "",
		    ...
		    maintenance === void 0 ? null : React14.createElement(MaintenanceReportDialog, {
		      key: "maintenance",
		    ...
		    databaseAction === void 0 ? null : React14.createElement(DatabaseActionDialog, {
		      key: "db-action",
		      api,
		      sourceId: source.id,
		      engineKind: source.kind,
		...
		function TableActionDialog(props) {
		  ...
		  if (state.kind === "batch") {
		    ...
		    return React14.createElement(Modal, {
		      ...
		      onClose: onCancel,
		      footer: [
		        React14.createElement("button", { key: "cancel", type: "button", className: "dbm-btn", disabled: busy, onClick: onCancel }, t("common.cancel")),
		        React14.createElement(
		          "button",
		      ...
		      children: React14.createElement(
		        "div",
		        null,
		        React14.createElement("div", null, t(truncate ? "db.batch.truncateBody" : "db.batch.dropBody", { n: state.tables.length })),
		        React14.createElement(
		          "div",
		          { className: "dbm-hint dbm-mono", style: { marginTop: 8, wordBreak: "break-all" } },
		          state.tables.map((table) => table.name).join("\u3001")
		        ),
		        truncate && views.length > 0 ? React14.createElement("div", { className: "dbm-hint", style: { marginTop: 8 } }, t("db.batch.truncateSkipped", { n: views.length })) : null
		      )
		    });
		  }
		  ...
		  return React14.createElement(Modal, {
		    ...
		    children: React14.createElement("div", null, body)
		  });
		}
		function TableOverview(props) {
		  ...
		  if (tables === void 0) {
		    return React14.createElement(
		      "div",
		      { className: "dbm-tab-body" },
		      React14.createElement("div", { className: "dbm-pad dbm-hint" }, t("db.loadingStats"))
		    );
		  }
		  ...
		  const action = (key, label, onClick, danger = false, disabled = false, title) => React14.createElement(
		    "button",
		    {
		      key,
		      type: "button",
		  ...
		  return React14.createElement(
		    ...
		    React14.createElement(
		      ...
		      React14.createElement("span", { className: "dbm-hint" }, `${t("db.op.title")}\uFF1A`),
		      ...
		      React14.createElement("span", { className: "dbm-batch-sep" }),
		      React14.createElement("button", {
		        type: "button",
		        className: "dbm-btn dbm-btn-sm",
		        disabled: busy,
		    ...
		    React14.createElement(
		      ...
		      React14.createElement("span", { className: "dbm-hint" }, t("db.filterPlaceholder")),
		      React14.createElement("input", {
		        className: "dbm-input",
		        value: filter,
		      ...
		      React14.createElement("span", { className: "dbm-hint" }, t("db.overviewFor", { schema, n: tables.length })),
		      React14.createElement("span", { className: "dbm-spacer" }),
		      /*
		      ...
		      React14.createElement(
		        ...
		        loading ? [React14.createElement("span", { key: "spin", className: "dbm-spinner" }), t("common.loading")] : t("common.refresh")
		      )
		    ),
		    React14.createElement(TableBatchBar, {
		      key: "batch",
		    ...
		    list.length === 0 ? React14.createElement(Empty, { message: tables.length === 0 ? t("db.overviewEmpty") : t("list.emptyFiltered") }) : React14.createElement(
		      "div",
		      { className: "dbm-scroll" },
		      React14.createElement(
		        "table",
		        ...
		        React14.createElement(
		          ...
		          React14.createElement(
		            ...
		            ...[t("db.col.table"), t("db.col.actions"), t("db.col.rows"), t("db.col.type"), t("db.col.collation"), t("db.col.size"), t("db.col.comment")].map(
		              (label) => React14.createElement("th", { key: label }, label)
		            )
		          )
		        ),
		        React14.createElement(
		          ...
		          list.map(
		            (table) => React14.createElement(
		              ...
		              React14.createElement(
		                "td",
		                { className: "dbm-mono" },
		                table.rows === void 0 ? React14.createElement("span", { className: "dbm-hint", title: t("db.rowsUnknown.hint") }, t("db.rowsUnknown")) : table.rows.toLocaleString()
		              ),
		              React14.createElement(
		                "td",
		                null,
		              ...
		              React14.createElement("td", { className: "dbm-mono" }, table.collation ?? t("common.none")),
		              React14.createElement("td", { className: "dbm-mono" }, formatBytes(table.size)),
		              React14.createElement("td", { title: table.comment ?? "" }, table.comment ?? "")
		            )
		          )
		        )
		      )
		...
		function SqlTabView(props) {
		  ...
		  const [sql, setSql] = React14.useState("");
		  const [allowWrite, setAllowWrite] = React14.useState(false);
		  ...
		  return React14.createElement(
		    ...
		    React14.createElement(
		      ...
		      React14.createElement(
		        "div",
		        { className: "dbm-row" },
		        React14.createElement("button", { type: "button", className: "dbm-btn dbm-btn-primary", disabled: busy, onClick: () => {
		          void run();
		        ...
		        React14.createElement("span", { className: "dbm-hint" }, t("sql.allowWrite.hint"))
		      )
		    ),
		    result === void 0 ? null : React14.createElement(
		      "div",
		      { className: "dbm-tab-body", style: { minHeight: 0 } },
		      React14.createElement("div", { className: "dbm-pad dbm-hint" }, result.message),
		      result.columns.length === 0 ? null : React14.createElement(
		        "div",
		        { className: "dbm-data" },
		        React14.createElement(
		          "table",
		          null,
		          React14.createElement("thead", null, React14.createElement("tr", null, result.columns.map((column) => React14.createElement("th", { key: column }, column)))),
		          React14.createElement(
		            "tbody",
		            null,
		            result.rows.map(
		              (row, index) => React14.createElement(
		                "tr",
		                { key: index },
		                row.map(
		                  (cell, cellIndex) => React14.createElement(
		                    "td",
		                    { key: cellIndex, className: isNull(cell) ? "dbm-null" : void 0, title: renderCell(cell) },
		                    renderCell(cell)
		                  )
		...
		function DatabasePanel(props) {
		  ...
		  const [snapshot, setSnapshot] = React15.useState(() => controller.getSnapshot());
		  const [sources, setSources] = React15.useState(void 0);
		  const [settings, setSettings] = React15.useState({ allowAgentWrite: false, requireApproval: true });
		  const [engines, setEngines] = React15.useState([]);
		  const [error, setError] = React15.useState(void 0);
		  void localeTick;
		  React15.useEffect(() => controller.subscribe(() => setSnapshot(controller.getSnapshot())), [controller]);
		  const reload = React15.useCallback(async () => {
		    try {
		  ...
		  const saveGate = React15.useCallback(async (patch) => {
		    try {
		  ...
		  const connect = React15.useCallback(async (source) => {
		    try {
		  ...
		  let body;
		  if (screen.name === "sql") {
		    body = React15.createElement(SqlDatabaseView, {
		      api,
		    ...
		    body = React15.createElement(RedisDatabaseView, {
		      api,
		      source: screen.source,
		    ...
		    body = React15.createElement(Empty, { message: t("common.loading") });
		  } else {
		    body = React15.createElement(SourceListView, {
		      api,
		      sources,
		      settings,
		      engines,
		    ...
		    try {
		      return container.inject(
		        ...
		        () => container.register(
		          ...
		          (props) => React16.createElement("span", {
		    ...
		    try {
		      return container.inject(
		        ...
		        () => container.register(
		          ...
		          () => React16.createElement(PanelHost, { controller, api, localeListeners, onClose: close })
		        )
		      );
		    } catch (failure) {
		...
		function PanelHost(props) {
		  ...
		  const [localeTick, setLocaleTick] = React16.useState(0);
		  React16.useEffect(() => {
		  ...
		  return React16.createElement(DatabasePanel, { controller, api, localeTick, onClose });
		}
