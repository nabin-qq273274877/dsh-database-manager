window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function RedisKeyTree(props) {
		  ...
		  const renderKey = (db, info, depth) => React2.createElement(
		    "div",
		    {
		      key: `key-${db}-${info.key}`,
		  ...
		  const renderLevel = (db, prefix, depth) => {
		    ...
		    for (const folder of folders) {
		      ...
		      rows2.push(
		        React2.createElement(
		          ...
		          React2.createElement("span", { className: "dbm-tree-name dbm-mono" }, folder.name),
		          React2.createElement("span", { className: "dbm-tree-meta" }, String(folder.keys)),
		          React2.createElement(
		            "span",
		            { className: "dbm-tree-actions" },
		            React2.createElement(
		    ...
		    for (const info of keys) rows2.push(renderKey(db, info, depth));
		    if (level.truncated) {
		      rows2.push(React2.createElement("div", {
		        key: `trunc-${db}-${prefix}`,
		        className: `dbm-tree-hint dbm-tree-depth-${Math.min(depth, 8)} dbm-hint`
		  ...
		  for (const node of databases) {
		    ...
		    rows.push(
		      React2.createElement(
		        ...
		        React2.createElement("span", { className: "dbm-tree-meta" }, String(node.keys)),
		        React2.createElement(
		          "span",
		          { className: "dbm-tree-actions" },
		          React2.createElement(
		...
		function RedisValueEditor(props) {
		  const { value } = props;
		  const head = React3.createElement(
		    "div",
		    { className: "dbm-pad" },
		    React3.createElement("div", { className: "dbm-row" }, React3.createElement("strong", { className: "dbm-mono" }, value.key)),
		    React3.createElement(
		      ...
		      React3.createElement(TtlEditor, {
		        key: "ttl",
		        api: props.api,
		        source: props.source,
		        db: props.db,
		      ...
		      value.truncated === true ? React3.createElement("span", { className: "dbm-hint" }, t("redis.truncated", { n: 1e3 })) : null
		    )
		  );
		  const body = (() => {
		    switch (value.type) {
		      case "string":
		        return React3.createElement(StringEditor, { ...props, content: value.value ?? "" });
		      case "list":
		        return React3.createElement(ListEditor, { ...props, items: value.items ?? [] });
		      case "set":
		        return React3.createElement(SetEditor, { ...props, items: value.items ?? [] });
		      case "hash":
		        return React3.createElement(HashEditor, { ...props, fields: value.fields ?? [] });
		      case "zset":
		        return React3.createElement(ZsetEditor, { ...props, members: value.members ?? [] });
		      default:
		        return React3.createElement(
		          React3.Fragment,
		          null,
		          React3.createElement(StreamView, { value }),
		          React3.createElement("div", { className: "dbm-pad dbm-hint" }, t("redisedit.readonlyType", { type: value.type }))
		        );
		    }
		  })();
		  return React3.createElement("div", { className: "dbm-tab-body" }, head, body);
		}
		function TtlEditor(props) {
		  const { api, source, db, value } = props;
		  const [editing, setEditing] = React3.useState(false);
		  const [seconds, setSeconds] = React3.useState("");
		  ...
		  if (!editing) {
		    return React3.createElement(
		      ...
		      React3.createElement("span", { className: "dbm-hint" }, `${t("redis.ttl")}: ${formatTtl(value.ttl)}`),
		      React3.createElement(
		        "button",
		        {
		          type: "button",
		  ...
		  return React3.createElement(
		    ...
		    React3.createElement("span", { className: "dbm-hint" }, t("redisnew.ttl.unit")),
		    React3.createElement(
		      "button",
		      {
		        type: "button",
		    ...
		    React3.createElement("button", { type: "button", className: "dbm-btn dbm-btn-sm", disabled: busy, onClick: () => setEditing(false) }, t("common.cancel"))
		  );
		}
		function StringEditor(props) {
		  const { api, source, db, value } = props;
		  const [draft, setDraft] = React3.useState(props.content);
		  const [busy, setBusy] = React3.useState(false);
		  React3.useEffect(() => {
		  ...
		  return React3.createElement(
		    ...
		    React3.createElement(
		      ...
		      React3.createElement(
		        ...
		        dirty ? React3.createElement("span", { className: "dbm-hint dbm-dirty" }, t("redisedit.unsaved")) : null
		      ),
		      ...
		      React3.createElement(
		        ...
		        React3.createElement("span", { className: "dbm-hint" }, t("redisedit.ctrlEnter"))
		      )
		    )
		  );
		}
		function ListEditor(props) {
		  ...
		  const [busy, setBusy] = React3.useState(false);
		  const [append, setAppend] = React3.useState("");
		  React3.useEffect(() => {
		    setDrafts({});
		  ...
		  return React3.createElement(
		    ...
		    React3.createElement(
		      "div",
		      { className: "dbm-data" },
		      items.length === 0 ? React3.createElement(Empty, { message: t("redis.noKeys") }) : React3.createElement(
		        "table",
		        null,
		        React3.createElement(
		          "thead",
		          ...
		          React3.createElement(
		            "tr",
		            null,
		            React3.createElement("th", { style: { width: "60px" } }, t("redisedit.index")),
		            React3.createElement("th", null, t("redis.value")),
		            React3.createElement("th", { style: { width: "120px" } }, t("col.actions"))
		          )
		        ),
		        React3.createElement(
		          "tbody",
		          ...
		          items.map((item, index) => {
		            ...
		            return React3.createElement(
		              "tr",
		              { key: `${value.key}-${index}` },
		              React3.createElement("td", { className: "dbm-hint" }, String(index)),
		              React3.createElement(
		                "td",
		                null,
		                React3.createElement("input", {
		...
		function SetEditor(props) {
		  ...
		  const [busy, setBusy] = React3.useState(false);
		  const [drafts, setDrafts] = React3.useState({});
		  const [add, setAdd] = React3.useState("");
		  React3.useEffect(() => {
		    setDrafts({});
		    setAdd("");
		  }, [value.key, items.length]);
		      ...
		      items.length === 0 ? React3.createElement(Empty, { message: t("redis.noKeys") }) : React3.createElement(
		        ...
		        React3.createElement(
		          ...
		          React3.createElement(
		            "tr",
		            null,
		            React3.createElement("th", null, t("redis.member")),
		            React3.createElement("th", { style: { width: "180px" } }, t("col.actions"))
		          )
		        ),
		        React3.createElement(
		          "tbody",
		...
		function HashEditor(props) {
		  ...
		  const [busy, setBusy] = React3.useState(false);
		  const [drafts, setDrafts] = React3.useState({});
		  const [add, setAdd] = React3.useState({ field: "", value: "" });
		  React3.useEffect(() => {
		    setDrafts({});
		    setAdd({ field: "", value: "" });
		  ...
		  return React3.createElement(
		    ...
		    React3.createElement(
		      "div",
		      { className: "dbm-data" },
		      fields.length === 0 ? React3.createElement(Empty, { message: t("redis.noKeys") }) : React3.createElement(
		        "table",
		        null,
		        React3.createElement(
		          "thead",
		          ...
		          React3.createElement(
		            "tr",
		            null,
		            React3.createElement("th", null, t("redis.field")),
		            React3.createElement("th", null, t("redis.value")),
		            React3.createElement("th", { style: { width: "190px" } }, t("col.actions"))
		          )
		        ),
		        React3.createElement(
		          "tbody",
		...
		function ZsetEditor(props) {
		  ...
		  const [busy, setBusy] = React3.useState(false);
		  const [drafts, setDrafts] = React3.useState({});
		  const [add, setAdd] = React3.useState({ member: "", score: "" });
		  const [problem, setProblem] = React3.useState(void 0);
		  React3.useEffect(() => {
		    setDrafts({});
		    setAdd({ member: "", score: "" });
		    setProblem(void 0);
		  ...
		  return React3.createElement(
		    "div",
		    { className: "dbm-tab-body" },
		    problem === void 0 ? null : React3.createElement("div", { className: "dbm-pad dbm-error" }, problem),
		    React3.createElement(
		      "div",
		      { className: "dbm-data" },
		      members.length === 0 ? React3.createElement(Empty, { message: t("redis.noKeys") }) : React3.createElement(
		        "table",
		        null,
		        React3.createElement(
		          "thead",
		          ...
		          React3.createElement(
		            "tr",
		            null,
		            React3.createElement("th", { style: { width: "140px" } }, t("redis.score")),
		            React3.createElement("th", null, t("redis.member")),
		            React3.createElement("th", { style: { width: "190px" } }, t("col.actions"))
		          )
		        ),
		...
		function StreamView(props) {
		  ...
		  return React3.createElement(
		    "div",
		    { className: "dbm-data" },
		    entries.length === 0 ? React3.createElement(Empty, { message: t("redis.noKeys") }) : React3.createElement(
		      "table",
		      null,
		      React3.createElement(
		        "thead",
		        ...
		        React3.createElement(
		          "tr",
		          null,
		          React3.createElement("th", null, t("redis.entry")),
		          React3.createElement("th", null, t("redis.field")),
		          React3.createElement("th", null, t("redis.value"))
		        )
		      ),
		      React3.createElement(
		        ...
		        entries.flatMap(
		          (entry) => entry.fields.map(
		            (field, index) => React3.createElement(
		              "tr",
		              { key: `${entry.id}-${index}` },
		              React3.createElement("td", { className: "dbm-mono" }, index === 0 ? entry.id : ""),
		              React3.createElement("td", { className: "dbm-mono" }, field.field),
		              React3.createElement("td", { className: "dbm-mono", title: field.value }, field.value)
		            )
		          )
		        )
		      )
		...
		function RedisDatabaseView(props) {
		  ...
		  const [info, setInfo] = React4.useState(initialInfo);
		  const [filter, setFilter] = React4.useState("");
		  const [levels, setLevels] = React4.useState({});
		  const [openDbs, setOpenDbs] = React4.useState(() => ({ [source.db ?? 0]: true }));
		  const [openFolders, setOpenFolders] = React4.useState({});
		  const [selection, setSelection] = React4.useState(void 0);
		  const [activeKey, setActiveKey] = React4.useState(void 0);
		  const [value, setValue] = React4.useState(void 0);
		  const [valueLoading, setValueLoading] = React4.useState(false);
		  const [tab, setTab] = React4.useState("value");
		  const [error, setError] = React4.useState(void 0);
		  const [notice, setNotice] = React4.useState(void 0);
		  const [createFor, setCreateFor] = React4.useState(void 0);
		  const [deleteFor, setDeleteFor] = React4.useState(void 0);
		  const [busy, setBusy] = React4.useState(false);
		  const loadLevel = React4.useCallback(async (db, prefix) => {
		  ...
		  const refreshAll = React4.useCallback(async () => {
		    try {
		  ...
		  const loadValue = React4.useCallback(async (db, key) => {
		  ...
		  const databases = React4.useMemo(() => {
		  ...
		  const left = React4.createElement(
		    "div",
		    { className: "dbm-side" },
		    ...
		    React4.createElement(
		      ...
		      React4.createElement(RedisKeyTree, {
		        databases,
		        levels,
		        openDbs,
		        openFolders,
		  ...
		  if (tab === "value") {
		    ...
		    body.push(
		      value === void 0 ? React4.createElement(Empty, { key: "empty", message: valueLoading ? t("common.loading") : t("redis.selectKey") }) : React4.createElement(RedisValueEditor, {
		  ...
		  if (tab === "info") {
		    body.push(React4.createElement(InfoView, {
		      key: "info",
		      info,
		      onRefresh: () => {
		        void refreshAll();
		  ...
		  if (tab === "console") {
		    body.push(
		      React4.createElement(ConsoleView, {
		        key: "console",
		        api,
		        source,
		  ...
		  return React4.createElement(
		    ...
		    React4.createElement(
		      ...
		      React4.createElement(BackButton, { onBack, label: t("panel.backToList") }),
		      React4.createElement("span", { className: "dbm-title" }, source.name),
		      React4.createElement("span", { className: "dbm-badge dbm-badge-redis" }, "redis"),
		      React4.createElement("span", { className: "dbm-subtitle dbm-mono" }, `${source.host ?? ""}:${source.port ?? ""}/db${activeDb}`),
		      React4.createElement("span", { className: "dbm-spacer" }),
		      React4.createElement(BackButton, { onBack: onClose })
		    ),
		    error === void 0 ? null : React4.createElement(ErrorBanner, { message: error }),
		    notice === void 0 ? null : React4.createElement("div", { className: "dbm-ok", style: { padding: "6px 14px" } }, notice),
		    React4.createElement("div", { className: "dbm-split" }, left, React4.createElement("div", { className: "dbm-main" }, body)),
		    createFor === void 0 ? null : React4.createElement(NewKeyDialog, {
		      db: createFor.db,
		    ...
		    deleteFor === void 0 ? null : React4.createElement(DeleteDialog, {
		    ...
		    React4.createElement(
		      ...
		      React4.createElement(
		        ...
		        React4.createElement(
		          "div",
		          { className: "dbm-row" },
		          React4.createElement("strong", null, t("redis.info")),
		          React4.createElement("span", { className: "dbm-spacer" }),
		          React4.createElement("button", { type: "button", className: "dbm-btn dbm-btn-sm", onClick: onRefresh }, t("common.refresh"))
		        ),
		        React4.createElement(
		          "div",
		          { className: "dbm-grid" },
		          facts.map(
		            ([label, val]) => React4.createElement(
		              "div",
		              { key: label },
		              React4.createElement("div", { className: "dbm-hint" }, label),
		              React4.createElement("div", { className: "dbm-mono" }, val)
		            )
		          )
		        ),
		        React4.createElement("strong", null, t("redis.databases")),
		        info.databases.length === 0 ? React4.createElement("div", { className: "dbm-hint" }, t("redis.noKeys")) : React4.createElement(
		          "table",
		          { className: "dbm-table" },
		          React4.createElement("thead", null, React4.createElement("tr", null, React4.createElement("th", null, t("redis.db")), React4.createElement("th", null, t("redis.keys")))),
		          React4.createElement(
		            "tbody",
		            null,
		            info.databases.map(
		              (entry) => React4.createElement(
		                "tr",
		                { key: entry.db },
		                React4.createElement("td", null, `db${entry.db}`),
		                React4.createElement("td", null, String(entry.keys))
		              )
		            )
		          )
		        )
		...
		function ConsoleView(props) {
		  ...
		  const [command, setCommand] = React4.useState("");
		  const [allowWrite, setAllowWrite] = React4.useState(false);
		  const [result, setResult] = React4.useState(void 0);
		  const [busy, setBusy] = React4.useState(false);
		  const run = async () => {
		  ...
		  return React4.createElement(
		    ...
		    React4.createElement(
		      ...
		      React4.createElement(
		        "div",
		        { className: "dbm-row" },
		        React4.createElement("button", { type: "button", className: "dbm-btn dbm-btn-primary", disabled: busy, onClick: () => {
		          void run();
		        ...
		        React4.createElement("span", { className: "dbm-hint" }, `db${db} \xB7 ${allowWrite ? t("redis.allowWrite.hint") : t("redis.readonlyNotice")}`)
		      )
		    ),
		    result === void 0 ? null : React4.createElement(
		      "div",
		      { className: "dbm-tab-body", style: { minHeight: 0 } },
		      React4.createElement("div", { className: "dbm-pad dbm-hint" }, result.message),
		      React4.createElement(
		        "div",
		        { className: "dbm-data" },
		        React4.createElement(
		          "table",
		          null,
		          React4.createElement("thead", null, React4.createElement("tr", null, result.columns.map((column) => React4.createElement("th", { key: column }, column)))),
		          React4.createElement(
		            "tbody",
		            null,
		            result.rows.map(
		              (row, index) => React4.createElement(
		                "tr",
		                { key: index },
		                row.map(
		                  (cell, cellIndex) => React4.createElement(
		                    "td",
		...
		function SourceFormDialog(props) {
		  ...
		  const [state, setState] = React5.useState(() => initialState(source, initialKind ?? "sqlite"));
		  const [busy, setBusy] = React5.useState(false);
		  const [testing, setTesting] = React5.useState(false);
		  const [error, setError] = React5.useState(void 0);
		  const [testResult, setTestResult] = React5.useState(void 0);
		  const patch = (next) => {
		  ...
		  const field = (label, control, key) => React5.createElement("label", { className: "dbm-label", key: key ?? label }, React5.createElement("span", null, label), control);
		  const input = (value, onChange, extra = {}) => React5.createElement("input", {
		    className: "dbm-input",
		    value,
		  ...
		  children.push(
		    field(
		      ...
		      React5.createElement(
		        ...
		        DB_KINDS.map((kind) => React5.createElement("option", { key: kind, value: kind }, kind))
		      ),
		      "kind"
		    )
		  );
		  if (isEdit) {
		    children.push(React5.createElement("div", { className: "dbm-hint", key: "kind-hint" }, t("form.kindLocked")));
		  }
		  children.push(
		    React5.createElement(
		      "div",
		      ...
		      isEdit ? field(t("form.id"), React5.createElement("div", { className: "dbm-mono" }, state.id), "id") : field(t("form.id"), input(state.id, (value) => patch({ id: value }), { placeholder: t("form.id.placeholder") }), "id"),
		  ...
		  if (state.kind === "sqlite") {
		    ...
		    children.push(React5.createElement("div", { className: "dbm-grid", key: "connection" }, connection));
		    if (state.kind === "mysql") {
		      children.push(React5.createElement("div", { className: "dbm-hint", key: "schemaless-hint" }, t("form.mysql.noDefaultSchema")));
		    }
		    children.push(
		      field(
		        t("form.password"),
		    ...
		    children.push(React5.createElement("div", { className: "dbm-hint", key: "tls-hint" }, t("form.tls.hint")));
		    children.push(
		      React5.createElement(
		        "div",
		        { className: "dbm-field-inline", key: "timeout" },
		        React5.createElement("span", null, t("form.timeout")),
		        React5.createElement("input", {
		          className: "dbm-input",
		        ...
		        React5.createElement("span", { className: "dbm-hint" }, t("form.timeout.unit"))
		      )
		    );
		  }
		  children.push(
		  ...
		  children.push(React5.createElement("div", { className: "dbm-hint", key: "readonly-hint" }, t("form.readonly.hint")));
		  children.push(
		    field(
		      t("form.description"),
		  ...
		  if (error !== void 0) children.push(React5.createElement(ErrorBanner, { key: "error", message: error }));
		  if (testResult !== void 0) {
		    children.push(
		      testResult.ok ? React5.createElement(
		        "div",
		        { className: "dbm-ok", key: "test-ok" },
		        t("form.test.ok", { ms: testResult.latencyMs ?? 0, version: testResult.serverVersion ?? "" }).trim(),
		        testResult.note === void 0 ? null : React5.createElement("div", { className: "dbm-hint" }, t("form.test.note", { note: testResult.note }))
		      ) : React5.createElement(ErrorBanner, { key: "test-fail", message: t("test.fail", { error: testResult.error ?? "" }) })
		    );
		  }
		  const footerBusy = busy || testing;
		  return React5.createElement(Modal, {
		    ...
		    footer: React5.createElement(
		      ...
		      React5.createElement(
		        ...
		        onTest === void 0 ? null : React5.createElement(
		          "button",
		          {
		            key: "test",
		            type: "button",
		      ...
		      React5.createElement(
		        ...
		        React5.createElement("button", { key: "cancel", type: "button", className: "dbm-btn", disabled: footerBusy, onClick: onClose }, t("form.cancel")),
		        React5.createElement("button", { key: "save", type: "button", className: "dbm-btn dbm-btn-primary", disabled: footerBusy, onClick: () => {
		          void submit();
		...
		function SourceListView(props) {
		  ...
		  const [term, setTerm] = React6.useState("");
		  const [groupMode, setGroupMode] = React6.useState("none");
		  const [tests, setTests] = React6.useState({});
		  const [error, setError] = React6.useState(void 0);
		  const [editing, setEditing] = React6.useState(void 0);
		  const [creating, setCreating] = React6.useState(false);
		  const [deleting, setDeleting] = React6.useState(void 0);
		    ...
		    for (const source of group.items) {
		      ...
		      rows.push(
		        React6.createElement(
		          "tr",
		          { key: source.id },
		          React6.createElement("td", null, React6.createElement("span", { className: `dbm-badge dbm-badge-${source.kind}` }, source.kind)),
		          React6.createElement(
		            "td",
		            null,
		            React6.createElement("div", { style: { fontWeight: 500 } }, source.name),
		            source.description === "" ? null : React6.createElement("div", { className: "dbm-hint" }, source.description),
		            React6.createElement("div", { className: "dbm-hint dbm-mono" }, source.id)
		          ),
		          React6.createElement("td", { className: "dbm-mono" }, hostOf(source)),
		          React6.createElement("td", null, source.kind === "mysql" ? source.user ?? t("common.none") : t("common.none")),
		          React6.createElement(
		            "td",
		            null,
		            authOf(source),
		            source.readonly ? React6.createElement("span", { className: "dbm-badge", style: { marginLeft: 6 } }, t("form.readonly")) : null
		          ),
		          React6.createElement(
		            "td",
		            null,
		            source.tags.length === 0 ? t("common.none") : React6.createElement(
		              "span",
		              { className: "dbm-tags" },
		              source.tags.map((tag) => React6.createElement("span", { key: tag, className: "dbm-badge" }, tag))
		            )
		          ),
		          React6.createElement(
		            "td",
		            ...
		            React6.createElement(
		              ...
		              React6.createElement("button", { type: "button", className: "dbm-btn dbm-btn-sm dbm-btn-primary", onClick: () => onConnect(source) }, t("action.connect")),
		              React6.createElement("button", { type: "button", className: "dbm-btn dbm-btn-sm", onClick: () => setEditing(source) }, t("action.edit")),
		              React6.createElement("button", { type: "button", className: "dbm-btn dbm-btn-sm dbm-btn-danger", onClick: () => setDeleting(source) }, t("action.delete"))
		            ),
		  ...
		  const children = [
		    React6.createElement(
		      ...
		      React6.createElement(
		        ...
		        React6.createElement("option", { value: "none" }, `${t("list.groupBy")}: ${t("list.group.none")}`),
		        React6.createElement("option", { value: "kind" }, `${t("list.groupBy")}: ${t("list.group.kind")}`),
		        React6.createElement("option", { value: "group" }, `${t("list.groupBy")}: ${t("list.group.group")}`),
		        React6.createElement("option", { value: "tag" }, `${t("list.groupBy")}: ${t("list.group.tag")}`)
		      ),
		      React6.createElement("span", { className: "dbm-hint" }, t("list.count", { n: filtered.length })),
		      React6.createElement("span", { className: "dbm-spacer" }),
		      React6.createElement("button", { type: "button", className: "dbm-btn dbm-btn-primary", onClick: () => setCreating(true) }, `+ ${t("list.new")}`)
		    )
		  ];
		  if (error !== void 0) {
		    children.push(React6.createElement(ErrorBanner, { key: "error", message: error }));
		  }
		  ...
		  children.push(
		    React6.createElement(
		      ...
		      sources.length === 0 ? React6.createElement(Empty, { message: t("list.empty") }) : filtered.length === 0 ? React6.createElement(Empty, { message: t("list.emptyFiltered") }) : React6.createElement(
		        "table",
		        { className: "dbm-table" },
		        React6.createElement(
		          "thead",
		          ...
		          React6.createElement(
		            ...
		            ...[t("col.kind"), t("col.name"), t("col.host"), t("col.user"), t("col.auth"), t("col.tags"), t("col.actions")].map(
		              (label) => React6.createElement("th", { key: label }, label)
		            )
		          )
		        ),
		        React6.createElement("tbody", null, rows)
		      )
		    )
		  );
		  ...
		  if (creating || editing !== void 0) {
		    children.push(
		      React6.createElement(SourceFormDialog, {
		        key: "form",
		  ...
		  if (deleting !== void 0) {
		    children.push(
		      React6.createElement(Modal, {
		        key: "delete",
		        title: t("delete.title"),
		        onClose: () => setDeleting(void 0),
		        footer: [
		          React6.createElement("button", { key: "cancel", type: "button", className: "dbm-btn", onClick: () => setDeleting(void 0) }, t("common.cancel")),
		          React6.createElement("button", { key: "ok", type: "button", className: "dbm-btn dbm-btn-danger", onClick: () => {
		            void remove(deleting);
		          } }, t("delete.confirm"))
		        ],
		        children: React6.createElement("div", null, t("delete.body", { name: deleting.name }))
		      })
		    );
		  }
		  return React6.createElement(
		    ...
		    React6.createElement(
		      "div",
		      { className: "dbm-header" },
		      React6.createElement(BackButton, { onBack: props.onBack }),
		      React6.createElement("span", { className: "dbm-title" }, t("panel.title")),
		      React6.createElement("span", { className: "dbm-subtitle" }, t("panel.subtitle")),
		      React6.createElement("span", { className: "dbm-spacer" }),
		      React6.createElement(
		        "span",
		        { className: "dbm-hint" },
		...
		function TestOutcome(state) {
		  if (state.status === "running") {
		    return React6.createElement("div", { className: "dbm-hint" }, t("common.loading"));
		  }
		  const { result } = state;
		  if (result.ok) {
		    return React6.createElement(
		  ...
		  return React6.createElement("div", { className: "dbm-error" }, t("test.fail", { error: result.error ?? "" }));
		}
		function GateStrip(props) {
		  const [busy, setBusy] = React6.useState(false);
		  const [savedAt, setSavedAt] = React6.useState(void 0);
		  ...
		  return React6.createElement(
		    ...
		    React6.createElement("span", { className: "dbm-spacer" }),
		    React6.createElement("span", { className: "dbm-hint" }, savedAt === void 0 ? t("gate.hint") : t("gate.saved"))
		  );
		}
		...
		function SqlDatabaseView(props) {
		  ...
		  const [schemas, setSchemas] = React7.useState(initialSchemas);
		  const [tableFilter, setTableFilter] = React7.useState("");
		  const [openSchemas, setOpenSchemas] = React7.useState({});
		  const [tablesBySchema, setTablesBySchema] = React7.useState({});
		  const [loadingSchemas, setLoadingSchemas] = React7.useState({});
		  const [activeSchema, setActiveSchema] = React7.useState(void 0);
		  const [activeTable, setActiveTable] = React7.useState(void 0);
		  const [tab, setTab] = React7.useState("browse");
		  const [error, setError] = React7.useState(void 0);
		  const [notice, setNotice] = React7.useState(void 0);
		  const [rows, setRows] = React7.useState(void 0);
		  const [page, setPage] = React7.useState(1);
		  const [pageSize, setPageSize] = React7.useState(200);
		  const [orderBy, setOrderBy] = React7.useState(void 0);
		  const [orderDir, setOrderDir] = React7.useState("asc");
		  const [columns, setColumns] = React7.useState([]);
		  const [indexes, setIndexes] = React7.useState([]);
		  const loadSchemas = React7.useCallback(async () => {
		  ...
		  const loadTables = React7.useCallback(async (schema, force = false) => {
		  ...
		  const loadRows = React7.useCallback(async (options) => {
		  ...
		  const loadStructure = React7.useCallback(async (schema, table) => {
		    try {
		  ...
		  const matchesFilter2 = (name) => tableFilter === "" || name.toLowerCase().includes(tableFilter.toLowerCase());
		  const tree = [];
		  for (const schema of schemas) {
		    ...
		    tree.push(
		      React7.createElement(
		        ...
		        React7.createElement("span", { className: "dbm-tree-caret" }, isOpen ? "\u25BE" : "\u25B8"),
		        React7.createElement("span", { className: "dbm-tree-name" }, schema),
		        tables === void 0 ? null : React7.createElement("span", { className: "dbm-tree-meta" }, String(tables.filter((table) => matchesFilter2(table.name)).length))
		      )
		    );
		    if (!isOpen) continue;
		    if (loading && tables === void 0) {
		      tree.push(React7.createElement("div", { key: `loading-${schema}`, className: "dbm-tree-item dbm-tree-indent-1 dbm-hint" }, t("common.loading")));
		      continue;
		    }
		    const list = (tables ?? []).filter((table) => matchesFilter2(table.name));
		    if (list.length === 0) {
		      tree.push(
		        React7.createElement(
		          "div",
		    ...
		    for (const table of list) {
		      tree.push(
		        React7.createElement(
		          ...
		          React7.createElement("span", { className: "dbm-tree-caret" }, table.type === "view" ? "\u25EB" : "\u25A4"),
		          React7.createElement("span", { className: "dbm-tree-name" }, table.name),
		          table.rows === void 0 ? null : React7.createElement("span", { className: "dbm-tree-meta" }, String(table.rows))
		        )
		      );
		    }
		  }
		  const left = React7.createElement(
		    "div",
		    { className: "dbm-side" },
		    React7.createElement(
		      "div",
		    ...
		    React7.createElement("div", { className: "dbm-side-body" }, tree)
		  );
		  const selection = activeSchema !== void 0 && activeTable !== void 0 ? { schema: activeSchema, table: activeTable } : void 0;
		  const body = [];
		  if (selection === void 0) {
		    body.push(React7.createElement(Empty, { key: "empty", message: t("db.selectTable") }));
		  } else {
		    body.push(
		      React7.createElement(TabStrip, {
		        key: "tabs",
		        active: tab,
		        tabs: [
		    ...
		    if (tab === "browse") {
		      body.push(React7.createElement(BrowseTab, {
		        key: "browse-body",
		        rows,
		        orderBy,
		        orderDir,
		    ...
		    if (tab === "structure") {
		      body.push(React7.createElement(StructureTab, { key: "structure-body", columns, indexes }));
		    }
		    if (tab === "sql") {
		      body.push(
		        React7.createElement(SqlTabView, {
		          key: "sql-body",
		          source,
		          schema: activeSchema,
		          api,
		    ...
		    if (tab === "search") {
		      body.push(
		        React7.createElement(SearchTab, {
		          key: "search-body",
		          onSearch: (payload) => {
		            void loadRows({
		    ...
		    if (tab === "insert") {
		      body.push(
		        React7.createElement(InsertTab, {
		          key: "insert-body",
		          api,
		          source,
		          schema: selection.schema,
		  ...
		  return React7.createElement(
		    ...
		    React7.createElement(
		      "div",
		      { className: "dbm-header" },
		      React7.createElement(BackButton, { onBack, label: t("panel.backToList") }),
		      React7.createElement("span", { className: "dbm-title" }, source.name),
		      React7.createElement("span", { className: `dbm-badge dbm-badge-${source.kind}` }, source.kind),
		      React7.createElement("span", { className: "dbm-subtitle dbm-mono" }, source.kind === "sqlite" ? source.file ?? "" : `${source.host ?? ""}:${source.port ?? ""}`),
		      React7.createElement("span", { className: "dbm-spacer" }),
		      React7.createElement(BackButton, { onBack: onClose })
		    ),
		    error === void 0 ? null : React7.createElement(ErrorBanner, { message: error }),
		    notice === void 0 ? null : React7.createElement("div", { className: "dbm-ok", style: { padding: "6px 14px" } }, notice),
		    React7.createElement("div", { className: "dbm-split" }, left, React7.createElement("div", { className: "dbm-main" }, body))
		  );
		}
		function emptyPage() {
		...
		function BrowseTab(props) {
		  ...
		  if (rows === void 0) return React7.createElement(Empty, { message: t("common.loading") });
		  if (rows.error !== void 0) return React7.createElement(ErrorBanner, { message: rows.error });
		  ...
		  return React7.createElement(
		    ...
		    React7.createElement(
		      ...
		      React7.createElement("button", { type: "button", className: "dbm-btn dbm-btn-sm", onClick: onRefresh }, t("browse.refresh")),
		      React7.createElement("label", { className: "dbm-hint" }, `${t("browse.pageSize")}: ${""}`),
		      React7.createElement(
		        "select",
		        {
		          className: "dbm-select",
		        ...
		        [50, 100, 200, 500, 1e3].map((size) => React7.createElement("option", { key: size, value: String(size) }, String(size)))
		      ),
		      React7.createElement("span", { className: "dbm-hint" }, t("browse.total", { n: page.total })),
		      React7.createElement("span", { className: "dbm-spacer" }),
		      rows.loading ? React7.createElement("span", { className: "dbm-hint" }, t("common.loading")) : null
		    ),
		    page.columns.length === 0 ? React7.createElement(Empty, { message: t("browse.empty") }) : React7.createElement(
		      "div",
		      { className: "dbm-data" },
		      React7.createElement(
		        "table",
		        ...
		        React7.createElement(
		          ...
		          null,
		          page.rows.map(
		            (row, index) => React7.createElement(
		              "tr",
		              { key: index },
		              columns.map(
		                (column) => React7.createElement(
		    ...
		    React7.createElement(
		      "div",
		      { className: "dbm-pager" },
		      React7.createElement("button", { type: "button", className: "dbm-btn dbm-btn-sm", disabled: page.page <= 1, onClick: () => onPage(page.page - 1) }, t("browse.prev")),
		      React7.createElement("span", null, t("browse.page", { page: page.page, pages })),
		      React7.createElement("button", { type: "button", className: "dbm-btn dbm-btn-sm", disabled: page.page >= pages, onClick: () => onPage(page.page + 1) }, t("browse.next")),
		      page.primaryKey.length === 0 ? React7.createElement("span", { className: "dbm-hint" }, t("browse.noPk")) : null
		    )
		  );
		}
		function StructureTab(props) {
		  ...
		  return React7.createElement(
		    ...
		    React7.createElement(
		      "div",
		      { className: "dbm-scroll" },
		      React7.createElement("div", { className: "dbm-pad" }, React7.createElement("strong", null, t("structure.columns"))),
		      React7.createElement(
		        "table",
		        { className: "dbm-table" },
		        React7.createElement(
		        ...
		        React7.createElement(
		          ...
		          columns.map(
		            (column) => React7.createElement(
		              "tr",
		              { key: column.name },
		              React7.createElement("td", { className: "dbm-mono" }, column.name),
		              React7.createElement("td", { className: "dbm-mono" }, column.type),
		              React7.createElement("td", null, column.nullable ? t("common.yes") : t("common.no")),
		              React7.createElement("td", null, column.key === "" ? t("common.none") : column.key),
		              React7.createElement("td", { className: "dbm-mono" }, column.defaultValue ?? t("common.none")),
		              React7.createElement("td", { className: "dbm-mono" }, column.extra ?? t("common.none")),
		              React7.createElement("td", null, column.comment ?? "")
		            )
		          )
		        )
		      ),
		      React7.createElement("div", { className: "dbm-pad" }, React7.createElement("strong", null, t("structure.indexes"))),
		      indexes.length === 0 ? React7.createElement("div", { className: "dbm-pad dbm-hint" }, t("structure.noIndexes")) : React7.createElement(
		        "table",
		        { className: "dbm-table" },
		        React7.createElement(
		          "thead",
		        ...
		        React7.createElement(
		          ...
		          null,
		          indexes.map(
		            (index) => React7.createElement(
		              "tr",
		              { key: index.name },
		              React7.createElement("td", { className: "dbm-mono" }, index.name),
		              React7.createElement("td", null, index.unique ? t("common.yes") : t("common.no")),
		              React7.createElement("td", { className: "dbm-mono" }, index.columns.join(", ")),
		              React7.createElement("td", null, index.type ?? t("common.none"))
		            )
		          )
		        )
		      )
		...
		function SqlTabView(props) {
		  ...
		  const [sql, setSql] = React7.useState("");
		  const [allowWrite, setAllowWrite] = React7.useState(false);
		  const [result, setResult] = React7.useState(void 0);
		  ...
		  return React7.createElement(
		    ...
		    React7.createElement(
		      ...
		      React7.createElement(
		        "div",
		        { className: "dbm-row" },
		        React7.createElement("button", { type: "button", className: "dbm-btn dbm-btn-primary", disabled: busy, onClick: () => {
		          void run();
		        ...
		        React7.createElement("span", { className: "dbm-hint" }, t("sql.allowWrite.hint"))
		      )
		    ),
		    result === void 0 ? null : React7.createElement(
		      "div",
		      { className: "dbm-tab-body", style: { minHeight: 0 } },
		      React7.createElement("div", { className: "dbm-pad dbm-hint" }, result.message),
		      result.columns.length === 0 ? null : React7.createElement(
		        "div",
		        { className: "dbm-data" },
		        React7.createElement(
		          "table",
		          null,
		          React7.createElement("thead", null, React7.createElement("tr", null, result.columns.map((column) => React7.createElement("th", { key: column }, column)))),
		          React7.createElement(
		            "tbody",
		            null,
		            result.rows.map(
		              (row, index) => React7.createElement(
		                ...
		                { key: index },
		                row.map(
		                  (cell, cellIndex) => React7.createElement(
		                    "td",
		                    { key: cellIndex, className: isNull(cell) ? "dbm-null" : void 0, title: renderCell(cell) },
		                    renderCell(cell)
		                  )
		...
		function SearchTab(props) {
		  ...
		  const [condition, setCondition] = React7.useState("");
		  const submit = () => {
		  ...
		  return React7.createElement(
		    ...
		    React7.createElement(
		      ...
		      React7.createElement(
		        ...
		        React7.createElement("button", { type: "button", className: "dbm-btn dbm-btn-primary", onClick: submit }, t("search.run"))
		      ),
		      React7.createElement(
		        "div",
		        { className: "dbm-row" },
		        React7.createElement("span", { className: "dbm-hint" }, t("search.condition")),
		        React7.createElement("input", {
		          className: "dbm-input dbm-mono",
		          style: { flex: 1 },
		          value: condition,
		    ...
		    rows === void 0 ? null : rows.error !== void 0 ? React7.createElement(ErrorBanner, { message: rows.error }) : React7.createElement(
		      "div",
		      { className: "dbm-tab-body", style: { minHeight: 0 } },
		      React7.createElement("div", { className: "dbm-pad dbm-hint" }, t("browse.total", { n: rows.page.total })),
		      React7.createElement(
		        "div",
		        { className: "dbm-data" },
		        React7.createElement(
		          "table",
		          null,
		          React7.createElement("thead", null, React7.createElement("tr", null, rows.page.columns.map((column) => React7.createElement("th", { key: column.name }, column.name)))),
		          React7.createElement(
		            "tbody",
		            null,
		            rows.page.rows.map(
		...
		function InsertTab(props) {
		  ...
		  const [useNull, setUseNull] = React7.useState({});
		  const [busy, setBusy] = React7.useState(false);
		  const submit = async () => {
		    const payload = [];
		  ...
		  return React7.createElement(
		    ...
		    React7.createElement(
		      ...
		      React7.createElement(
		        "div",
		        { className: "dbm-pad" },
		        React7.createElement("strong", null, `${t("insert.title")} \u2014 ${table}`),
		        React7.createElement("div", { className: "dbm-hint" }, t("insert.hint")),
		        React7.createElement(
		          "div",
		          ...
		          columns.map(
		            (column) => React7.createElement(
		              ...
		              React7.createElement(
		                ...
		                null,
		                column.name,
		                React7.createElement("span", { className: "dbm-hint" }, ` \xB7 ${column.type}${column.nullable ? "" : " NOT NULL"}${column.key === "PRI" ? " PK" : ""}`)
		              ),
		              React7.createElement("input", {
		                className: "dbm-input dbm-mono",
		              ...
		              column.nullable ? React7.createElement(
		                "span",
		                { className: "dbm-check" },
		                React7.createElement("input", {
		                  type: "checkbox",
		...
		function DatabasePanel(props) {
		  ...
		  const [snapshot, setSnapshot] = React8.useState(() => controller.getSnapshot());
		  const [sources, setSources] = React8.useState(void 0);
		  const [settings, setSettings] = React8.useState({ allowAgentWrite: false, requireApproval: true });
		  const [engines, setEngines] = React8.useState([]);
		  const [error, setError] = React8.useState(void 0);
		  void localeTick;
		  React8.useEffect(() => controller.subscribe(() => setSnapshot(controller.getSnapshot())), [controller]);
		  ...
		  const saveGate = React8.useCallback(async (patch) => {
		    try {
		  ...
		  const connect = React8.useCallback(async (source) => {
		    try {
		  ...
		  let body;
		  if (screen.name === "sql") {
		    body = React8.createElement(SqlDatabaseView, {
		      api,
		    ...
		    body = React8.createElement(RedisDatabaseView, {
		      api,
		      source: screen.source,
		    ...
		    body = React8.createElement(Empty, { message: t("common.loading") });
		  } else {
		    body = React8.createElement(SourceListView, {
		      api,
		      sources,
		      settings,
		      engines,
		    ...
		    try {
		      return container.inject(
		        ...
		        () => container.register(
		          ...
		          (props) => React9.createElement("span", {
		    ...
		    try {
		      return container.inject(
		        ...
		        () => container.register(
		          ...
		          () => React9.createElement(PanelHost, { controller, api, localeListeners, onClose: close })
		        )
		      );
		    } catch (failure) {
		...
		function PanelHost(props) {
		  ...
		  const [localeTick, setLocaleTick] = React9.useState(0);
		  React9.useEffect(() => {
		  ...
		  return React9.createElement(DatabasePanel, { controller, api, localeTick, onClose });
		}
