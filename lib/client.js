window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var zh = {
		  ...
		  "createTable.intoSchema": "\u5C06\u521B\u5EFA\u5728\u300C{schema}\u300D\u4E2D\u3002",
		  ...
		  "createTable.compositeHint": "\u8054\u5408\u7D22\u5F15\uFF1A\u52FE\u9009\u7D22\u5F15\u7C7B\u578B\u540E\uFF0C\u628A\u591A\u4E2A\u5B57\u6BB5\u7684\u300C\u7D22\u5F15\u540D\u300D\u586B\u6210\u540C\u4E00\u4E2A\u540D\u5B57\uFF0C\u5B83\u4EEC\u5C31\u7EC4\u6210\u4E00\u4E2A\u8054\u5408\u7D22\u5F15\uFF0C\u5B57\u6BB5\u987A\u5E8F\u5373\u7D22\u5F15\u5217\u987A\u5E8F\u3002",
		  ...
		  "createTable.default.hint": "\u4E0D\u8BBE\u7F6E\uFF1D\u6CA1\u6709\u9ED8\u8BA4\u503C\uFF08\u63D2\u5165\u7701\u7565\u8BE5\u5217\u65F6\u4E3A NULL\uFF09\uFF1B\u8981\u7A7A\u5B57\u7B26\u4E32\u8BF7\u9009\u300C\u81EA\u5B9A\u4E49\u300D\u5E76\u7559\u7A7A",
		  ...
		  "createTable.hint": "\u7C7B\u578B\u53EF\u76F4\u63A5\u8F93\u5165\uFF0C\u4E0B\u9762\u662F\u5E38\u7528\u7C7B\u578B\u7684\u5EFA\u8BAE\u3002\u52FE\u9009\u300C\u4E3B\u952E\u300D\u7684\u5B57\u6BB5\u5373\u7EC4\u6210\u4E3B\u952E\uFF0C\u987A\u5E8F\u6309\u5B57\u6BB5\u987A\u5E8F\u3002",
		...
		var en = {
		  ...
		  "createTable.intoSchema": "Will be created in \u201C{schema}\u201D.",
		  ...
		  "createTable.compositeHint": "Composite index: after choosing an index type, give several columns the SAME index name and they become one index, in column order.",
		  ...
		  "createTable.default.hint": "No default = no DEFAULT clause (an omitted column inserts NULL); for the empty string choose Custom and leave the box blank",
		  ...
		  "createTable.hint": "The type is free text; the suggestions are common ones. Ticking Key makes a column part of the primary key, in column order.",
		...
		function SqlInsertTab(props) {
		  ...
		  const buildRow = (form) => {
		    ...
		    for (const column of editable) {
		      ...
		      if (field.mode === "default") {
		        if (!column.nullable && column.defaultValue === void 0 && !autoAssigns(source.kind, column)) {
		  ...
		  const submit = async (keepGoing) => {
		    ...
		    if (payloads.length === 0) {
		      onError(t("insert.required", { column: editable[0]?.name ?? table }));
		      return;
		    }
		    setBusy(true);
		    try {
		    ...
		    if (kind.kind === "enum") {
		      return React9.createElement(
		        "select",
		        {
		          ...
		          onChange: (event) => apply2({ mode: "value", text: event.target.value })
		        },
		        [
		          React9.createElement("option", { key: "", value: "" }, field.mode === "default" ? t("insert.useDefault") : "\u2014"),
		  ...
		  return React9.createElement(
		    ...
		    React9.createElement(
		      ...
		      React9.createElement(
		        ...
		        forms.length > 1 ? React9.createElement("div", { className: "dbm-hint" }, t("insert.rowsHint")) : null,
		        ...forms.map((form, index) => React9.createElement(
		          ...
		          React9.createElement(
		            ...
		            ...editable.map((column) => {
		              const field = fieldOf(form, column);
		              const kind = fieldKind(column);
		              const setMode = (patch) => setField(index, column.name, { ...field, ...patch });
		              return React9.createElement(
		                "label",
		                ...
		                React9.createElement(
		                  ...
		                  column.comment === void 0 || column.comment === "" ? null : React9.createElement("span", { className: "dbm-hint" }, ` \xB7 ${column.comment}`)
		                ),
		                ...
		                React9.createElement(
		                  ...
		                  React9.createElement(
		                    ...
		                    t("insert.useDefault") + (column.defaultValue === void 0 ? "" : t("insert.defaultSuffix", { value: column.defaultValue }))
		                  ),
		                  column.nullable ? React9.createElement(
		                    "label",
		                    { className: "dbm-check" },
		                    React9.createElement("input", {
		                      type: "radio",
		                  ...
		                  kind.kind === "enum" ? React9.createElement("span", { className: "dbm-hint" }, t("insert.enumHint")) : null
		                )
		              );
		            })
		          )
		...
		function SqlSearchTab(props) {
		  ...
		  const nextId = React10.useRef(1);
		  const [rows, setRows] = React10.useState([]);
		  const [localJoin, setLocalJoin] = React10.useState(join);
		  const filterKey = JSON.stringify(filters) + "|" + join;
		  const lastApplied = React10.useRef(filterKey);
		  React10.useEffect(() => {
		  ...
		  const addRow = () => {
		    ...
		    setRows((current) => [...current, {
		      id: nextId.current++,
		      column: first?.name ?? "",
		      operator: first === void 0 ? "eq" : operatorsFor(first.type)[0] ?? "eq",
		      value: "",
		      value2: ""
		    }]);
		  };
		  const toFilters = () => {
		    ...
		    for (const [index, row] of rows.entries()) {
		      ...
		      if (isUnaryOperator(row.operator)) {
		        out.push({ column: row.column, operator: row.operator });
		        continue;
		      }
		  ...
		  return React10.createElement(
		    ...
		    React10.createElement(
		      "div",
		      { className: "dbm-pad" },
		      React10.createElement("div", { className: "dbm-hint" }, t("search.join")),
		      React10.createElement(
		        "select",
		        {
		          className: "dbm-select",
		          style: { width: 180 },
		          value: localJoin,
		          onChange: (event) => setLocalJoin(event.target.value === "or" ? "or" : "and")
		        },
		        React10.createElement("option", { value: "and" }, t("search.join.and")),
		        React10.createElement("option", { value: "or" }, t("search.join.or"))
		      ),
		      rows.length === 0 ? React10.createElement("div", { className: "dbm-hint" }, t("search.noConditions")) : React10.createElement(
		        "div",
		        { className: "dbm-pad", style: { padding: 0 } },
		        ...rows.map((row, index) => {
		          const column = columns.find((candidate) => candidate.name === row.column);
		          const operators = column === void 0 ? [...ROW_FILTER_OPERATORS] : operatorsFor(column.type);
		          return React10.createElement(
		            "div",
		            ...
		            React10.createElement(
		              "select",
		              {
		                ...
		                onChange: (event) => {
		                  ...
		                  const allowed = next === void 0 ? [...ROW_FILTER_OPERATORS] : operatorsFor(next.type);
		                  update(row.id, {
		              ...
		              columns.map((candidate) => React10.createElement(
		                "option",
		                { key: candidate.name, value: candidate.name },
		            ...
		            React10.createElement(
		              "select",
		              {
		                ...
		                value: row.operator,
		                onChange: (event) => update(row.id, { operator: event.target.value })
		              },
		              operators.map((operator) => React10.createElement("option", { key: operator, value: operator }, t(`search.op.${operator}`)))
		            ),
		            isUnaryOperator(row.operator) ? null : React10.createElement("input", {
		              className: "dbm-input",
		              ...
		              ...row.operator === "in" ? {} : {
		                ...
		                ...column === void 0 ? {} : inputHints(column)
		              },
		            ...
		            row.operator === "between" ? [
		              React10.createElement("span", { key: "sep", className: "dbm-hint" }, "\u2014"),
		              React10.createElement("input", {
		                ...
		                ...column === void 0 ? {} : inputHints(column),
		                onChange: (event) => update(row.id, { value2: event.target.value })
		              })
		            ] : null,
		      ...
		      React10.createElement(
		        "div",
		        { className: "dbm-row" },
		        React10.createElement("button", { type: "button", className: "dbm-btn dbm-btn-sm", onClick: addRow }, `+ ${t("search.addCondition")}`),
		        React10.createElement("button", {
		          type: "button",
		          className: "dbm-btn dbm-btn-sm dbm-btn-primary",
		        ...
		        React10.createElement("span", { className: "dbm-spacer" }),
		        total === void 0 ? null : React10.createElement("span", { className: "dbm-hint" }, t("search.matched", { n: total }))
		      )
		    ),
		    React10.createElement(
		      "div",
		      { className: "dbm-pad" },
		      React10.createElement("div", { className: "dbm-hint" }, t("search.hint"))
		    ),
		    // The result grid, in its own scroll area so the form above keeps its height
		    // and the rows get the rest of the tab.
		    results === void 0 ? null : React10.createElement("div", { className: "dbm-tab-body", style: { minHeight: 0 } }, results)
		  );
		}
		...
		function SqlStructureTab(props) {
		  ...
		  const [editor, setEditor] = React11.useState(void 0);
		  const [confirming, setConfirming] = React11.useState(void 0);
		  const [selected, setSelected] = React11.useState(/* @__PURE__ */ new Set());
		  const [distinct, setDistinct] = React11.useState(void 0);
		  const [keyEditor, setKeyEditor] = React11.useState(void 0);
		  const [indexForm, setIndexForm] = React11.useState(void 0);
		  ...
		  const submitEditor = async () => {
		    ...
		    const body = editor.mode === "add" ? { action: "addColumn", column: { ...spec, name } } : {
		      action: "alterColumn",
		  ...
		  const header = React11.createElement(
		    "tr",
		    null,
		  ...
		  const rows = columns.map(
		    (column) => React11.createElement(
		      ...
		      React11.createElement("td", { className: "dbm-mono" }, column.name),
		      React11.createElement("td", { className: "dbm-mono" }, column.type === "" ? t("common.none") : column.type),
		      React11.createElement("td", null, column.nullable ? t("common.yes") : t("common.no")),
		      React11.createElement(
		        "td",
		        null,
		        kindLabel(column),
		        column.primaryKeyPosition !== void 0 && primaryColumns.length > 1 ? React11.createElement("span", { className: "dbm-key-note" }, ` ${t("structure.keyOrder", { n: column.primaryKeyPosition })}`) : null
		      ),
		      React11.createElement("td", { className: "dbm-mono" }, column.defaultValue ?? t("common.none")),
		      React11.createElement("td", { className: "dbm-mono" }, column.extra ?? t("common.none")),
		      React11.createElement(
		        "td",
		        null,
		      ...
		      React11.createElement("td", null, column.comment ?? ""),
		      React11.createElement(
		        "td",
		  ...
		  const indexHeader = React11.createElement(
		    "tr",
		    null,
		    ...[t("structure.index.name"), t("structure.index.unique"), t("structure.index.columns"), t("structure.index.type"), t("structure.index.actions")].map((label) => React11.createElement("th", { key: label }, label))
		  );
		  const indexRows = indexes.map(
		    (index) => React11.createElement(
		      "tr",
		      { key: index.name },
		      React11.createElement("td", { className: "dbm-mono" }, index.name),
		      React11.createElement("td", null, index.unique ? t("common.yes") : t("common.no")),
		      React11.createElement("td", { className: "dbm-mono" }, index.columns.join(", ")),
		      React11.createElement("td", null, index.primary === true ? t("structure.primaryKey") : index.type ?? t("common.none")),
		      React11.createElement(
		        "td",
		        { className: "dbm-row-actions" },
		        React11.createElement("button", {
		  ...
		  return React11.createElement(
		    ...
		    React11.createElement(
		      ...
		      React11.createElement(
		        "div",
		        { className: "dbm-row", style: { padding: "8px 12px" } },
		        React11.createElement("button", { type: "button", className: "dbm-btn dbm-btn-sm dbm-btn-primary", disabled: busy, onClick: startAdd }, `+ ${t("structure.addColumn")}`),
		        React11.createElement("button", {
		          type: "button",
		          className: "dbm-btn dbm-btn-sm",
		        ...
		        selected.size === 0 ? null : [
		          React11.createElement("span", { key: "count", className: "dbm-hint" }, t("structure.selected", { n: selected.size })),
		          React11.createElement("button", {
		            key: "drop",
		            type: "button",
		            className: "dbm-btn dbm-btn-sm dbm-btn-danger",
		        ...
		        React11.createElement(
		          ...
		          loading ? [React11.createElement("span", { key: "spin", className: "dbm-spinner" }), t("common.loading")] : t("common.refresh")
		        )
		      ),
		      error === void 0 ? null : React11.createElement(ErrorBanner, { message: error }),
		      editor === void 0 ? null : React11.createElement(ColumnEditor, {
		        key: "editor",
		        editor,
		        kind,
		        columns,
		      ...
		      React11.createElement(
		        "div",
		        { className: "dbm-pad" },
		        React11.createElement("strong", null, `${t("structure.columns")}\uFF08${columns.length}\uFF09`)
		      ),
		      React11.createElement(
		        "table",
		        { className: "dbm-table" },
		        React11.createElement("thead", null, header),
		        React11.createElement("tbody", null, ...rows)
		      ),
		      React11.createElement(
		        "div",
		        { className: "dbm-pad" },
		        React11.createElement("strong", null, `${t("structure.indexes")}\uFF08${indexes.length}\uFF09`)
		      ),
		      indexForm === void 0 ? null : React11.createElement(IndexCreator, {
		        key: "index-form",
		        form: indexForm,
		        columns,
		        indexes,
		      ...
		      indexes.length === 0 ? React11.createElement("div", { className: "dbm-pad dbm-hint" }, t("structure.noIndexes")) : React11.createElement(
		        "table",
		        { className: "dbm-table" },
		        React11.createElement("thead", null, indexHeader),
		        React11.createElement("tbody", null, ...indexRows)
		      ),
		      keyEditor === void 0 ? null : React11.createElement(KeyEditor, {
		        key: "key-editor",
		        columns,
		        order: keyEditor,
		        busy,
		    ...
		    distinct === void 0 ? null : React11.createElement(Modal, {
		      title: t("structure.distinctTitle"),
		      onClose: () => setDistinct(void 0),
		      footer: [React11.createElement("button", { key: "ok", type: "button", className: "dbm-btn", onClick: () => setDistinct(void 0) }, t("common.close"))],
		      children: React11.createElement(
		        "div",
		        null,
		    ...
		    confirming === void 0 ? null : React11.createElement(ConfirmChange, {
		      key: "confirm",
		      confirming,
		      busy,
		      kind,
		...
		function ConfirmChange(props) {
		  ...
		  return React11.createElement(Modal, {
		    title,
		    onClose: onCancel,
		    footer: [
		      React11.createElement("button", { key: "cancel", type: "button", className: "dbm-btn", disabled: busy, onClick: onCancel }, t("common.cancel")),
		      React11.createElement("button", {
		        key: "ok",
		        type: "button",
		        className: "dbm-btn dbm-btn-danger",
		    ...
		    children: React11.createElement(
		      "div",
		      null,
		      React11.createElement("div", null, body),
		      isBatch ? React11.createElement("div", { className: "dbm-hint", style: { marginTop: 8 } }, confirming.columns.join("\u3001")) : null,
		      showRebuild ? React11.createElement("div", { className: "dbm-hint", style: { marginTop: 8 } }, t("structure.dropRebuildNote")) : null
		    )
		  });
		}
		function ColumnEditor(props) {
		  ...
		  const field = (key, label, control, hint) => React11.createElement(
		    "div",
		    { className: "dbm-field", key },
		    React11.createElement("label", { className: "dbm-field-label" }, label),
		    control,
		    hint === void 0 ? null : React11.createElement("div", { className: "dbm-hint" }, hint)
		  );
		  return React11.createElement(Modal, {
		    ...
		    children: React11.createElement(
		      "div",
		      null,
		      field("name", t("structure.colName"), React11.createElement("input", {
		        className: "dbm-input",
		        value: spec.name,
		      ...
		      field(
		        ...
		        React11.createElement(
		          ...
		          [
		            ...options.map((type) => React11.createElement("option", { key: type === "" ? "__none__" : type, value: type }, type === "" ? t("common.none") : type)),
		            React11.createElement("option", { key: "__other__", value: "__other__" }, t("structure.typeOther"))
		          ]
		        )
		      ),
		      field("typeText", t("structure.typeText"), React11.createElement("input", {
		        className: "dbm-input dbm-mono",
		        value: spec.type,
		        ...
		        onChange: (event) => onChange({ ...spec, type: event.target.value })
		      })),
		      field(
		        "nullable",
		        t("structure.col.nullable"),
		        React11.createElement(
		          ...
		          React11.createElement("input", {
		            ...
		            onChange: (event) => onChange({ ...spec, nullable: event.target.checked })
		          }),
		          t("structure.col.nullable")
		        ),
		        existing?.primaryKeyPosition === void 0 ? void 0 : t("structure.nullableKeyHint")
		      ),
		      field("default", t("structure.col.default"), React11.createElement("input", {
		        className: "dbm-input dbm-mono",
		        value: spec.defaultValue ?? "",
		        placeholder: t("structure.defaultPlaceholder"),
		        "aria-label": t("structure.col.default"),
		        spellcheck: false,
		        onChange: (event) => onChange({ ...spec, defaultValue: event.target.value })
		      })),
		      field("comment", t("structure.col.comment"), React11.createElement("input", {
		        className: "dbm-input",
		        value: spec.comment ?? "",
		        placeholder: t("structure.commentPlaceholder"),
		        "aria-label": t("structure.col.comment"),
		        onChange: (event) => onChange({ ...spec, comment: event.target.value })
		      })),
		      editor.mode === "edit" && existing?.generated === true ? React11.createElement("div", { className: "dbm-hint" }, t("structure.generatedHint")) : null
		    )
		  });
		}
		  ...
		  return React11.createElement(Modal, {
		    ...
		    children: React11.createElement(
		      ...
		      React11.createElement(
		        "div",
		        { className: "dbm-field" },
		        React11.createElement("label", { className: "dbm-field-label" }, t("structure.indexName")),
		        React11.createElement("input", {
		          className: "dbm-input",
		          value: form.name,
		      ...
		      React11.createElement(
		        "div",
		        { className: "dbm-field" },
		        React11.createElement("label", { className: "dbm-field-label" }, t("structure.indexColumns")),
		        React11.createElement(
		          "div",
		          ...
		          ...columns.map((column, position) => {
		            ...
		            return React11.createElement(
		              ...
		              React11.createElement("span", { className: "dbm-column-order" }, at === -1 ? "" : String(at + 1)),
		              React11.createElement("span", { className: "dbm-mono" }, column.name),
		              React11.createElement("span", { className: "dbm-hint" }, column.type === "" ? "" : column.type),
		              void position
		            );
		          })
		        ),
		        React11.createElement("div", { className: "dbm-hint" }, t("structure.indexColumnsHint"))
		      ),
		      React11.createElement(
		        "div",
		        { className: "dbm-field" },
		      ...
		      form.columns.length === 0 ? null : React11.createElement("div", { className: "dbm-hint" }, `${t("structure.indexOrderPreview")}: ${form.columns.join(", ")}`)
		    )
		  });
		}
		function KeyEditor(props) {
		  ...
		  return React11.createElement(Modal, {
		    ...
		    children: React11.createElement(
		      "div",
		      null,
		      React11.createElement("div", { className: "dbm-hint" }, t("structure.keyBody")),
		      ...columns.map((column) => {
		        ...
		        return React11.createElement(
		          ...
		          React11.createElement("span", { className: "dbm-mono" }, column.name),
		          React11.createElement("span", { className: "dbm-hint" }, ` ${column.type}`),
		          at === -1 ? null : React11.createElement("span", { className: "dbm-key-note" }, ` \u2014 ${t("structure.keyOrder", { n: at + 1 })}`)
		        );
		      }),
		      rebuild ? React11.createElement("div", { className: "dbm-hint", style: { marginTop: 10 } }, t("structure.dropRebuildNote")) : null
		    )
		  });
		}
		...
		function TableBatchBar(props) {
		  ...
		  return React12.createElement(
		    ...
		    React12.createElement("span", null, t("db.selectedCount", { n: selected.length })),
		    ...
		    React12.createElement("span", { className: "dbm-batch-sep" }),
		    React12.createElement(
		      "button",
		    ...
		    engineKind === "sqlite" ? React12.createElement("span", { className: "dbm-hint" }, t("db.maint.repairMissing")) : null,
		    ...
		    React12.createElement("button", { type: "button", className: "dbm-btn dbm-btn-sm", disabled: busy, onClick: onClear }, t("common.cancel"))
		  );
		}
		function DatabaseActionDialog(props) {
		  ...
		  const [name, setName] = React12.useState("");
		  const [charset, setCharset] = React12.useState("");
		  const [collate, setCollate] = React12.useState("");
		  const [includeData, setIncludeData] = React12.useState(true);
		  const [confirmText, setConfirmText] = React12.useState("");
		  const [charsets, setCharsets] = React12.useState([]);
		  const [defaultCollations, setDefaultCollations] = React12.useState({});
		  const [collationsByCharset, setCollationsByCharset] = React12.useState({});
		  const [collationsLoaded, setCollationsLoaded] = React12.useState(false);
		  React12.useEffect(() => {
		  ...
		  const collationChoices = React12.useMemo(
		    () => charset === "" ? [] : collationsByCharset[charset] ?? [],
		    [charset, collationsByCharset]
		  );
		  const [currentDefaults, setCurrentDefaults] = React12.useState(void 0);
		  React12.useEffect(() => {
		  ...
		  const body = charsetUnsupported ? React12.createElement("div", { className: "dbm-hint" }, t("db.op.charsetNoSqlite")) : React12.createElement(
		    "div",
		    null,
		    React12.createElement("div", { className: "dbm-hint" }, t(action === "create" ? "db.op.createBody" : action === "rename" ? "db.op.renameBody" : action === "copy" ? "db.op.copyBody" : action === "drop" ? "db.op.dropBody" : "db.op.charsetBody")),
		    /*
		     ...
		     */
		    action === "charset" && currentDefaults !== void 0 ? React12.createElement(
		      "div",
		    ...
		    React12.createElement(
		      "div",
		      { className: "dbm-field" },
		      React12.createElement("label", { className: "dbm-field-label" }, t(action === "rename" ? "db.op.newName" : "db.op.name")),
		      React12.createElement("input", {
		        className: "dbm-input dbm-mono",
		        value: name,
		        "data-dbm-dbop-name": "",
		      ...
		      action === "rename" ? React12.createElement("div", { className: "dbm-hint" }, `\u2190 ${schema ?? ""}`) : null
		    ),
		    action === "create" || action === "charset" ? React12.createElement(
		      "div",
		      { className: "dbm-field" },
		      React12.createElement("label", { className: "dbm-field-label" }, t("db.op.charset")),
		      charsets.length === 0 ? React12.createElement("input", {
		        className: "dbm-input dbm-mono",
		        value: charset,
		        placeholder: "utf8mb4",
		        ...
		        [React12.createElement("option", { key: "", value: "" }, t("common.none")), ...charsets.map((value) => React12.createElement("option", { key: value, value }, value))]
		      )
		    ) : null,
		    /*
		    ...
		    action === "create" || action === "charset" ? React12.createElement(
		      "div",
		      { className: "dbm-field" },
		      React12.createElement("label", { className: "dbm-field-label" }, t("db.op.collate")),
		      collationChoices.length > 0 ? React12.createElement(
		        "select",
		        {
		          className: "dbm-select",
		          value: collate,
		        ...
		        [
		          React12.createElement("option", { key: "", value: "" }, t("db.op.collateDefault")),
		          ...collationChoices.map((value) => React12.createElement(
		            "option",
		            { key: value, value },
		    ...
		    action === "copy" ? React12.createElement(
		      "label",
		      { className: "dbm-check" },
		      React12.createElement("input", {
		        type: "checkbox",
		    ...
		    action === "drop" ? React12.createElement(
		      "div",
		      { className: "dbm-field" },
		      React12.createElement("label", { className: "dbm-field-label" }, t("db.op.dropConfirm", { from: schema ?? "" })),
		      React12.createElement("input", {
		        className: "dbm-input dbm-mono",
		        value: confirmText,
		  ...
		  return React12.createElement(Modal, {
		    ...
		    footer: [
		      React12.createElement("button", { key: "cancel", type: "button", className: "dbm-btn", disabled: busy, onClick: onClose }, t("common.cancel")),
		      React12.createElement(
		        "button",
		        {
		          key: "ok",
		         ...
		         */
		        busy ? [React12.createElement("span", { key: "spin", className: "dbm-spinner" }), t("db.op.busy")] : t("db.op.submit")
		      )
		    ],
		    children: body
		  });
		...
		function MaintenanceReportDialog(props) {
		  ...
		  return React12.createElement(Modal, {
		    ...
		    footer: [
		      React12.createElement("button", { key: "close", type: "button", className: "dbm-btn", disabled: running, onClick: onClose }, t("common.close"))
		    ],
		    children: running ? React12.createElement(
		      "div",
		      { className: "dbm-row" },
		      React12.createElement("span", { className: "dbm-spinner" }),
		      ...
		      React12.createElement("span", null, t(`db.maint.running.${op ?? "check"}`))
		    ) : React12.createElement(
		      "div",
		      null,
		      outcomes.length === 0 ? React12.createElement(ErrorBanner, { message: t("common.error", { error: "\u2014" }) }) : React12.createElement("div", { className: "dbm-ok" }, t("db.maint.resultCount", { n: outcomes.length, ok, failed })),
		      // SQLite's maintenance acts on the whole file, which the user must know to
		      // read the per-table lines correctly.
		      engineKind === "sqlite" ? React12.createElement("div", { className: "dbm-hint" }, t("db.maint.scopeWholeDb")) : null,
		      React12.createElement(
		        "div",
		        { className: "dbm-maint-report" },
		        ...outcomes.map((outcome) => React12.createElement(
		          "div",
		          { key: `${outcome.op}-${outcome.table}`, className: "dbm-maint-entry" },
		          React12.createElement(
		            "div",
		            { className: "dbm-row" },
		            React12.createElement("span", { className: `dbm-badge${outcome.ok ? " dbm-badge-ok" : " dbm-badge-err"}` }, outcome.ok ? t("common.yes") : t("common.no")),
		            React12.createElement("strong", { className: "dbm-mono" }, outcome.table)
		          ),
		          ...outcome.messages.map((message, index) => React12.createElement("div", { key: index, className: "dbm-hint dbm-mono" }, message))
		        ))
		      )
		    )
		  });
		...
		function CreateTableDialog(props) {
		  ...
		  const [columns, setColumns] = React13.useState(() => [blank(kind, true)]);
		  const [tableComment, setTableComment] = React13.useState("");
		  const [tableCollate, setTableCollate] = React13.useState("");
		  const [tableEngine, setTableEngine] = React13.useState(isSqlite ? "" : "InnoDB");
		  const [withoutRowid, setWithoutRowid] = React13.useState(false);
		  const [strict, setStrict] = React13.useState(false);
		  const [busy, setBusy] = React13.useState(false);
		  const [localError, setLocalError] = React13.useState(void 0);
		  const patch = (id, next) => {
		  ...
		  const [customTypeRows, setCustomTypeRows] = React13.useState(/* @__PURE__ */ new Set());
		  const typeCell = (column, index) => {
		    ...
		    return React13.createElement(
		      ...
		      [
		        ...groups.map((group) => React13.createElement(
		          "optgroup",
		          { key: group.label, label: t(group.label) },
		          ...group.types.map((value) => React13.createElement("option", { key: value, value }, value))
		        )),
		        ...
		        isListed ? null : React13.createElement("option", { key: "__customValue__", value: "__customValue__" }, `${column.type} ${t("createTable.typeCustomMark")}`),
		        React13.createElement("option", { key: "__custom__", value: "__custom__" }, t("createTable.typeCustom"))
		      ].filter((entry) => entry !== null)
		    );
		  };
		  const defaultCell = (column, index) => {
		    const select = React13.createElement(
		      "select",
		      {
		        className: "dbm-select",
		      ...
		      [
		        React13.createElement("option", { key: "none", value: "none" }, t("common.none")),
		        React13.createElement("option", { key: "custom", value: "custom" }, t("createTable.default.custom")),
		        React13.createElement("option", { key: "null", value: "null" }, "NULL"),
		  ...
		  const attributeSelect = (column, index) => {
		    ...
		    return React13.createElement(
		      ...
		      [
		        React13.createElement("option", { key: "__summary__", value: "" }, summary),
		        ...
		        chosen.length === 0 ? null : React13.createElement("option", { key: "__clear__", value: "__clear__" }, t("createTable.attributesClear"))
		      ].filter((entry) => entry !== null)
		    );
		  };
		  const indexSelect = (column, index) => React13.createElement(
		    "select",
		    {
		      className: "dbm-select",
		    ...
		    [
		      React13.createElement("option", { key: "", value: "" }, t("common.none")),
		  ...
		  const rowFor = (column, index) => {
		    ...
		    const autoHint = autoHolder !== void 0 ? t("createTable.autoAlreadyTaken", { name: autoHolder.name.trim() === "" ? t("createTable.thisColumn") : autoHolder.name.trim() }) : autoBlocker === void 0 ? null : autoBlocker === "notKey" ? t("createTable.autoNeedsKey") : autoBlocker === "notInteger" ? t("createTable.autoNeedsInteger", { name: column.name.trim() === "" ? t("createTable.thisColumn") : column.name.trim() }) : t("createTable.autoNeedsNumeric", { name: column.name.trim() === "" ? t("createTable.thisColumn") : column.name.trim() });
		    return React13.createElement(
		      "tr",
		      { key: column.id, "data-dbm-newtable-row": String(index) },
		      /* 字段名 */
		      React13.createElement("td", null, React13.createElement("input", {
		        className: "dbm-input dbm-mono",
		        value: column.name,
		       ...
		       */
		      React13.createElement("td", null, typeCell(column, index)),
		      /* 长度/值 */
		      React13.createElement("td", null, React13.createElement("input", {
		        className: "dbm-input dbm-mono",
		        value: column.length,
		      ...
		      /* 排序规则 */
		      React13.createElement("td", null, React13.createElement(
		        "select",
		        {
		          className: "dbm-select",
		        ...
		        collationList.map((value) => React13.createElement("option", { key: value === "" ? "__none__" : value, value }, value === "" ? t("common.none") : value))
		      )),
		      /* 属性: a dropdown, as asked */
		      React13.createElement("td", null, attributeSelect(column, index)),
		      /* 索引 */
		      React13.createElement("td", null, indexSelect(column, index)),
		      /* 索引名（联合索引用） */
		      React13.createElement("td", null, React13.createElement("input", {
		        className: "dbm-input dbm-mono",
		       ...
		       */
		      React13.createElement("td", null, defaultCell(column, index)),
		      /*
		      ...
		      React13.createElement(
		        ...
		        autoHint === null ? null : React13.createElement(
		          "div",
		      ...
		      /* 删除该行 */
		      React13.createElement("td", null, React13.createElement("button", {
		        type: "button",
		        className: "dbm-btn dbm-btn-sm",
		  ...
		  const body = React13.createElement(
		    "div",
		    null,
		    /* ---- the table itself ------------------------------------------------ *
		     *
		    ...
		    React13.createElement(
		      ...
		      React13.createElement(
		        ...
		        React13.createElement("label", { className: "dbm-grid-label", htmlFor: "dbm-newtable-name" }, t("createTable.tableName")),
		        React13.createElement("input", {
		      ...
		      React13.createElement(
		        "div",
		        { className: "dbm-grid-row" },
		        React13.createElement("label", { className: "dbm-grid-label", htmlFor: "dbm-newtable-tablecomment" }, t("createTable.tableComment")),
		        React13.createElement("input", {
		      ...
		      React13.createElement(
		        "div",
		        { className: "dbm-grid-row" },
		        React13.createElement("label", { className: "dbm-grid-label", htmlFor: "dbm-newtable-tableengine" }, t("createTable.tableEngine")),
		        isSqlite ? React13.createElement("input", {
		          className: "dbm-input dbm-mono dbm-grid-control",
		          ...
		          ENGINES.map((value) => React13.createElement("option", { key: value, value }, value))
		        )
		      ),
		      React13.createElement(
		        "div",
		        { className: "dbm-grid-row" },
		        React13.createElement("label", { className: "dbm-grid-label", htmlFor: "dbm-newtable-tablecollate" }, t("createTable.tableCollate")),
		        isSqlite ? React13.createElement("input", {
		          className: "dbm-input dbm-mono dbm-grid-control",
		          ...
		          collationList.map((value) => React13.createElement("option", { key: value === "" ? "__none__" : value, value }, value === "" ? t("createTable.tableCollateDefault") : value))
		        )
		      ),
		      /*
		       ...
		       */
		      isSqlite ? React13.createElement(
		        "div",
		        { className: "dbm-grid-row" },
		        React13.createElement("span", { className: "dbm-grid-label" }, t("createTable.tableTail")),
		        React13.createElement(
		          "div",
		    ...
		    React13.createElement("div", { className: "dbm-hint" }, t("createTable.intoSchema", { schema })),
		    /* ---- the columns ---- */
		    React13.createElement(
		      "div",
		      { className: "dbm-field" },
		      React13.createElement("label", { className: "dbm-field-label" }, t("createTable.columns")),
		      React13.createElement(
		        "div",
		        { className: "dbm-scroll" },
		        React13.createElement(
		          ...
		          React13.createElement("thead", null, React13.createElement(
		            "tr",
		            null,
		            ...columnHeaders.map((label, index) => React13.createElement(
		              "th",
		              { key: `${label}-${index}`, title: index === 4 ? t("createTable.attributesHint") : index === 6 ? t("createTable.indexNameHint") : void 0 },
		              label
		            ))
		          )),
		          React13.createElement("tbody", null, ...columns.map(rowFor))
		        )
		      ),
		      React13.createElement(
		        "div",
		        { className: "dbm-row" },
		        React13.createElement("button", { type: "button", className: "dbm-btn dbm-btn-sm", "data-dbm-newtable-add": "", onClick: addRow }, t("createTable.addColumn"))
		      ),
		      React13.createElement("div", { className: "dbm-hint" }, t("createTable.hint")),
		      /*
		       ...
		       */
		      React13.createElement("div", { className: "dbm-hint" }, t("createTable.default.hint")),
		      React13.createElement("div", { className: "dbm-hint" }, t("createTable.compositeHint"))
		    ),
		    localError === void 0 ? null : React13.createElement("div", { className: "dbm-error dbm-pad", role: "alert", "data-dbm-newtable-error": "" }, localError)
		  );
		  return React13.createElement(Modal, {
		    ...
		    footer: [
		      ...
		      React13.createElement(
		        ...
		        busy ? [React13.createElement("span", { key: "spin", className: "dbm-spinner" }), t("common.loading")] : t("createTable.submit")
		      )
		    ],
		    children: body
		  });
		...
		function ExportDialog(props) {
		  ...
		  const [format, setFormat] = React14.useState(rowsOnly === true ? "csv" : "sql");
		  const [scope, setScope] = React14.useState(
		    hasSelection ? "selected" : rowsOnly === true ? "table" : "table"
		  );
		  const [includeStructure, setIncludeStructure] = React14.useState(true);
		  const [includeData, setIncludeData] = React14.useState(true);
		  const [drop, setDrop] = React14.useState(false);
		  const [busy, setBusy] = React14.useState(false);
		  const [result, setResult] = React14.useState(void 0);
		  React14.useEffect(() => {
		  ...
		  const row = (label, control) => React14.createElement(
		    "div",
		    { className: "dbm-row" },
		    React14.createElement("span", { className: "dbm-hint", style: { width: 110, flex: "none" } }, label),
		    control
		  );
		  return React14.createElement(Modal, {
		    ...
		    onClose,
		    footer: [
		      React14.createElement("button", { key: "close", type: "button", className: "dbm-btn", disabled: busy, onClick: onClose }, t("common.close")),
		    ...
		    children: React14.createElement(
		      "div",
		      null,
		      row(t("export.format"), React14.createElement(
		        "select",
		        {
		          className: "dbm-select",
		          value: format,
		        ...
		        React14.createElement("option", { value: "sql" }, t("export.format.sql")),
		        React14.createElement("option", { value: "csv" }, t("export.format.csv"))
		      )),
		      format === "csv" ? null : row(
		        t("export.scope"),
		        React14.createElement(
		          ...
		          [
		            React14.createElement("option", { key: "schema", value: "schema" }, t("export.scope.schema", { n: tableCount })),
		            hasTable ? React14.createElement("option", { key: "table", value: "table" }, t("export.scope.table")) : null,
		            hasSelection ? React14.createElement("option", { key: "selected", value: "selected" }, t("export.scope.selected")) : null
		          ].filter((entry) => entry !== null)
		        )
		      ),
		      presetTables !== void 0 && presetTables.length > 0 ? React14.createElement(
		        "div",
		      ...
		      drop ? React14.createElement("div", { className: "dbm-hint" }, t("export.dropWarn")) : null,
		      result === void 0 ? null : React14.createElement(
		        "div",
		        { className: "dbm-ok" },
		        t("export.done", { name: result.filename, size: formatBytes(result.size) }),
		        result.truncated.length === 0 ? null : React14.createElement("div", { className: "dbm-hint" }, t("export.truncated", { n: result.truncated.length }))
		      ),
		      React14.createElement("div", { className: "dbm-hint" }, t("export.hint"))
		    )
		  });
		}
		function ImportDialog(props) {
		  const { api, source, schema, table, tables, onClose, onDone, onError } = props;
		  const [format, setFormat] = React14.useState("sql");
		  const [target, setTarget] = React14.useState(table ?? tables[0]?.name ?? "");
		  const [hasHeader, setHasHeader] = React14.useState(true);
		  const [emptyAsNull, setEmptyAsNull] = React14.useState(true);
		  const [file, setFile] = React14.useState(void 0);
		  const [busy, setBusy] = React14.useState(false);
		  const [result, setResult] = React14.useState(void 0);
		  const read = (chosen) => {
		  ...
		  return React14.createElement(Modal, {
		    ...
		    children: React14.createElement(
		      "div",
		      null,
		      row(t("import.format"), React14.createElement(
		        "select",
		        {
		          className: "dbm-select",
		          value: format,
		        ...
		        React14.createElement("option", { value: "sql" }, t("import.format.sql")),
		        React14.createElement("option", { value: "csv" }, t("import.format.csv"))
		      )),
		      format === "csv" ? [
		        row(t("import.table"), React14.createElement(
		          "select",
		          {
		            key: "target",
		            className: "dbm-select",
		          ...
		          tables.filter((entry) => entry.type !== "view").map((entry) => React14.createElement("option", { key: entry.name, value: entry.name }, entry.name))
		        )),
		        React14.createElement("div", { key: "hint", className: "dbm-hint" }, t("import.tableHint")),
		        row("", React14.createElement(
		          "label",
		        ...
		        hasHeader ? null : React14.createElement("div", { key: "hh", className: "dbm-hint" }, t("import.hasHeaderHint")),
		        row("", React14.createElement(
		          "label",
		        ...
		        React14.createElement("div", { key: "nh", className: "dbm-hint" }, t("import.emptyAsNullHint"))
		      ] : null,
		      row(t("import.file"), React14.createElement("input", {
		        type: "file",
		        className: "dbm-input",
		      ...
		      file === void 0 ? React14.createElement("div", { className: "dbm-hint" }, t("import.noFile")) : React14.createElement("div", { className: "dbm-hint" }, `${file.name} \xB7 ${formatBytes(file.size)}`),
		      React14.createElement("div", { className: "dbm-hint" }, t("import.warn")),
		      result === void 0 ? null : React14.createElement("div", { className: "dbm-ok" }, result),
		      React14.createElement("div", { className: "dbm-hint" }, t("import.hint"))
		    )
		  });
		}
		...
		function SqlDatabaseView(props) {
		  ...
		  const [schemas, setSchemas] = React15.useState(initialSchemas);
		  const [tableFilter, setTableFilter] = React15.useState("");
		  const [openSchemas, setOpenSchemas] = React15.useState({});
		  const [tablesBySchema, setTablesBySchema] = React15.useState({});
		  const [loadingSchemas, setLoadingSchemas] = React15.useState({});
		  const [activeSchema, setActiveSchema] = React15.useState(void 0);
		  const [activeTable, setActiveTable] = React15.useState(void 0);
		  const [tab, setTab] = React15.useState("browse");
		  const [error, setError] = React15.useState(void 0);
		  const [notice, setNotice] = React15.useState(void 0);
		  const [rows, setRows] = React15.useState(void 0);
		  const [browse, setBrowse] = React15.useState({ page: 1, pageSize: 200, orderDir: "asc" });
		  const [columns, setColumns] = React15.useState([]);
		  const [indexes, setIndexes] = React15.useState([]);
		  const [structureLoading, setStructureLoading] = React15.useState(false);
		  const [transfer, setTransfer] = React15.useState(void 0);
		  const [schemaTables, setSchemaTables] = React15.useState([]);
		  const [selectedTables, setSelectedTables] = React15.useState(/* @__PURE__ */ new Set());
		  const [maintenanceSupport, setMaintenanceSupport] = React15.useState([]);
		  const [maintenance, setMaintenance] = React15.useState(void 0);
		  const [databaseAction, setDatabaseAction] = React15.useState(void 0);
		  const [batchBusy, setBatchBusy] = React15.useState(false);
		  const [creatingTable, setCreatingTable] = React15.useState(false);
		  const [statsBySchema, setStatsBySchema] = React15.useState({});
		  const statsBySchemaRef = React15.useRef(statsBySchema);
		  statsBySchemaRef.current = statsBySchema;
		  const [statsLoading, setStatsLoading] = React15.useState(false);
		  const [confirming, setConfirming] = React15.useState(void 0);
		  const [acting, setActing] = React15.useState(false);
		  const loadSchemas = React15.useCallback(async () => {
		  ...
		  const loadTables = React15.useCallback(async (schema, force = false) => {
		  ...
		  const loadStats = React15.useCallback(async (schema, force = false) => {
		  ...
		  const loadRows = React15.useCallback(async (options) => {
		  ...
		  const loadStructure = React15.useCallback(async (schema, table) => {
		  ...
		  const reloadCurrent = React15.useCallback(() => {
		  ...
		  for (const schema of schemas) {
		    ...
		    tree.push(
		      React15.createElement(
		        ...
		        React15.createElement("span", { className: "dbm-node-name" }, schema),
		        /*
		         ...
		         */
		        tables === void 0 ? null : React15.createElement("span", { className: "dbm-tree-meta" }, String(tables.length))
		      )
		    );
		    if (!isOpen) continue;
		    if (loading && tables === void 0) {
		      tree.push(React15.createElement("div", { key: `loading-${schema}`, className: "dbm-tree-item dbm-tree-indent-1 dbm-hint" }, t("common.loading")));
		      continue;
		    }
		    ...
		    for (const table of list) {
		      tree.push(
		        React15.createElement(
		          ...
		          React15.createElement("span", { className: "dbm-tree-caret" }, table.type === "view" ? "\u25EB" : "\u25A4"),
		          React15.createElement("span", { className: "dbm-tree-name" }, table.name),
		          table.rows === void 0 ? null : React15.createElement("span", { className: "dbm-tree-meta" }, String(table.rows))
		        )
		      );
		    }
		  }
		  const [sideRefreshing, setSideRefreshing] = React15.useState(false);
		  const refreshSide = React15.useCallback(async () => {
		  ...
		  const left = React15.createElement(
		    "div",
		    { className: "dbm-side" },
		    React15.createElement(
		      "div",
		       ...
		       */
		      source.kind === "mysql" ? React15.createElement("button", {
		        type: "button",
		        className: "dbm-btn dbm-btn-sm",
		      ...
		      React15.createElement(
		        ...
		        sideRefreshing ? React15.createElement("span", { className: "dbm-spinner" }) : "\u27F3"
		      )
		    ),
		    React15.createElement("div", { className: "dbm-side-body" }, tree)
		  );
		  ...
		  if (activeSchema === void 0) {
		    body.push(React15.createElement(Empty, { key: "empty", message: t("db.selectSchema") }));
		  } else if (selection === void 0) {
		    body.push(
		      React15.createElement(TableOverview, {
		        key: "overview",
		        schema: activeSchema,
		    ...
		    body.push(
		      React15.createElement(TabStrip, {
		        key: "tabs",
		        active: tab,
		        tabs: [
		    ...
		    if (tab === "browse") {
		      body.push(React15.createElement(SqlBrowseTab, {
		        key: "browse-body",
		        api,
		        sourceId: source.id,
		    ...
		    if (tab === "structure") {
		      body.push(React15.createElement(SqlStructureTab, {
		        key: "structure-body",
		        api,
		        sourceId: source.id,
		        schema: selection.schema,
		    ...
		    if (tab === "sql") {
		      body.push(
		        React15.createElement(SqlTabView, {
		          key: "sql-body",
		          source,
		          schema: activeSchema,
		          api,
		    ...
		    if (tab === "search") {
		      body.push(
		        React15.createElement(SqlSearchTab, {
		          key: "search-body",
		          columns,
		          ...
		          onSearch: (filters, join) => {
		            const merged = { ...browse, page: 1, filters, filterJoin: join };
		            setBrowse(merged);
		            void loadRows({
		              schema: selection.schema,
		              table: selection.table,
		           ...
		           */
		          results: React15.createElement(SqlBrowseTab, {
		            key: "search-results",
		            api,
		            sourceId: source.id,
		            schema: selection.schema,
		    ...
		    if (tab === "insert") {
		      body.push(
		        React15.createElement(SqlInsertTab, {
		          key: "insert-body",
		          api,
		          source,
		          schema: selection.schema,
		  ...
		  return React15.createElement(
		    ...
		    React15.createElement(
		      "div",
		      { className: "dbm-header" },
		      React15.createElement(BackButton, { onBack, label: t("panel.backToList") }),
		      React15.createElement("span", { className: "dbm-title" }, source.name),
		      React15.createElement("span", { className: `dbm-badge dbm-badge-${source.kind}` }, source.kind),
		      React15.createElement("span", { className: "dbm-subtitle dbm-mono" }, source.kind === "sqlite" ? source.file ?? "" : `${source.host ?? ""}:${source.port ?? ""}`),
		      React15.createElement("span", { className: "dbm-spacer" }),
		      React15.createElement(BackButton, { onBack: onClose })
		    ),
		    error === void 0 ? null : React15.createElement(ErrorBanner, { message: error }),
		    notice === void 0 ? null : React15.createElement("div", { className: "dbm-ok", style: { padding: "6px 14px" } }, notice),
		    React15.createElement("div", { className: "dbm-split" }, left, React15.createElement("div", { className: "dbm-main" }, body)),
		    confirming === void 0 ? null : React15.createElement(TableActionDialog, {
		      key: "confirm",
		      state: confirming,
		    ...
		    transfer === void 0 ? null : transfer.kind === "export" ? React15.createElement(ExportDialog, {
		      key: "export",
		      api,
		      source,
		      schema: activeSchema ?? "",
		    ...
		    }) : React15.createElement(ImportDialog, {
		      key: "import",
		      api,
		      source,
		      schema: activeSchema ?? "",
		    ...
		    maintenance === void 0 ? null : React15.createElement(MaintenanceReportDialog, {
		      key: "maintenance",
		    ...
		    creatingTable && activeSchema !== void 0 ? React15.createElement(CreateTableDialog, {
		      key: "create-table",
		      api,
		      sourceId: source.id,
		      schema: activeSchema,
		    ...
		    databaseAction === void 0 ? null : React15.createElement(DatabaseActionDialog, {
		      key: "db-action",
		      api,
		      sourceId: source.id,
		      engineKind: source.kind,
		...
		function TableActionDialog(props) {
		  ...
		  if (state.kind === "batch") {
		    ...
		    return React15.createElement(Modal, {
		      ...
		      onClose: onCancel,
		      footer: [
		        React15.createElement("button", { key: "cancel", type: "button", className: "dbm-btn", disabled: busy, onClick: onCancel }, t("common.cancel")),
		        React15.createElement(
		          "button",
		      ...
		      children: React15.createElement(
		        "div",
		        null,
		        React15.createElement("div", null, t(truncate ? "db.batch.truncateBody" : "db.batch.dropBody", { n: state.tables.length })),
		        React15.createElement(
		          "div",
		          { className: "dbm-hint dbm-mono", style: { marginTop: 8, wordBreak: "break-all" } },
		          state.tables.map((table) => table.name).join("\u3001")
		        ),
		        truncate && views.length > 0 ? React15.createElement("div", { className: "dbm-hint", style: { marginTop: 8 } }, t("db.batch.truncateSkipped", { n: views.length })) : null
		      )
		    });
		  }
		  ...
		  return React15.createElement(Modal, {
		    ...
		    children: React15.createElement("div", null, body)
		  });
		}
		function TableOverview(props) {
		  ...
		  if (tables === void 0) {
		    return React15.createElement(
		      "div",
		      { className: "dbm-tab-body" },
		      React15.createElement("div", { className: "dbm-pad dbm-hint" }, t("db.loadingStats"))
		    );
		  }
		  ...
		  const action = (key, label, onClick, danger = false, disabled = false, title) => React15.createElement(
		    "button",
		    {
		      key,
		      type: "button",
		  ...
		  return React15.createElement(
		    ...
		    React15.createElement(
		      ...
		      React15.createElement("span", { className: "dbm-hint" }, `${t("db.op.title")}\uFF1A`),
		      ...
		      React15.createElement("span", { className: "dbm-batch-sep" }),
		      React15.createElement("button", {
		        type: "button",
		        className: "dbm-btn dbm-btn-sm",
		        disabled: busy,
		    ...
		    React15.createElement(
		      ...
		      React15.createElement("span", { className: "dbm-hint" }, t("db.filterPlaceholder")),
		      React15.createElement("input", {
		        className: "dbm-input",
		        value: filter,
		      ...
		      React15.createElement("span", { className: "dbm-hint" }, t("db.overviewFor", { schema, n: tables.length })),
		      React15.createElement("span", { className: "dbm-spacer" }),
		      /*
		      ...
		      React15.createElement(
		        ...
		        loading ? [React15.createElement("span", { key: "spin", className: "dbm-spinner" }), t("common.loading")] : t("common.refresh")
		      )
		    ),
		    React15.createElement(TableBatchBar, {
		      key: "batch",
		    ...
		    list.length === 0 ? React15.createElement(Empty, { message: tables.length === 0 ? t("db.overviewEmpty") : t("list.emptyFiltered") }) : React15.createElement(
		      "div",
		      { className: "dbm-scroll" },
		      React15.createElement(
		        "table",
		        ...
		        React15.createElement(
		          ...
		          React15.createElement(
		            ...
		            ...[t("db.col.table"), t("db.col.actions"), t("db.col.rows"), t("db.col.type"), t("db.col.collation"), t("db.col.size"), t("db.col.comment")].map(
		              (label) => React15.createElement("th", { key: label }, label)
		            )
		          )
		        ),
		        React15.createElement(
		          ...
		          list.map(
		            (table) => React15.createElement(
		              ...
		              React15.createElement(
		                "td",
		                { className: "dbm-mono" },
		                table.rows === void 0 ? React15.createElement("span", { className: "dbm-hint", title: t("db.rowsUnknown.hint") }, t("db.rowsUnknown")) : table.rows.toLocaleString()
		              ),
		              React15.createElement(
		                "td",
		                null,
		              ...
		              React15.createElement("td", { className: "dbm-mono" }, table.collation ?? t("common.none")),
		              React15.createElement("td", { className: "dbm-mono" }, formatBytes(table.size)),
		              React15.createElement("td", { title: table.comment ?? "" }, table.comment ?? "")
		            )
		          )
		        )
		      )
		...
		function SqlTabView(props) {
		  ...
		  const [sql, setSql] = React15.useState("");
		  const [allowWrite, setAllowWrite] = React15.useState(false);
		  ...
		  return React15.createElement(
		    ...
		    React15.createElement(
		      ...
		      React15.createElement(
		        "div",
		        { className: "dbm-row" },
		        React15.createElement("button", { type: "button", className: "dbm-btn dbm-btn-primary", disabled: busy, onClick: () => {
		          void run();
		        ...
		        React15.createElement("span", { className: "dbm-hint" }, t("sql.allowWrite.hint"))
		      )
		    ),
		    result === void 0 ? null : React15.createElement(
		      "div",
		      { className: "dbm-tab-body", style: { minHeight: 0 } },
		      React15.createElement("div", { className: "dbm-pad dbm-hint" }, result.message),
		      result.columns.length === 0 ? null : React15.createElement(
		        "div",
		        { className: "dbm-data" },
		        React15.createElement(
		          "table",
		          null,
		          React15.createElement("thead", null, React15.createElement("tr", null, result.columns.map((column) => React15.createElement("th", { key: column }, column)))),
		          React15.createElement(
		            "tbody",
		            null,
		            result.rows.map(
		              (row, index) => React15.createElement(
		                "tr",
		                { key: index },
		                row.map(
		                  (cell, cellIndex) => React15.createElement(
		                    "td",
		                    { key: cellIndex, className: isNull(cell) ? "dbm-null" : void 0, title: renderCell(cell) },
		                    renderCell(cell)
		                  )
		...
		function DatabasePanel(props) {
		  ...
		  const [snapshot, setSnapshot] = React16.useState(() => controller.getSnapshot());
		  const [sources, setSources] = React16.useState(void 0);
		  const [settings, setSettings] = React16.useState({ allowAgentWrite: false, requireApproval: true });
		  const [engines, setEngines] = React16.useState([]);
		  const [error, setError] = React16.useState(void 0);
		  void localeTick;
		  React16.useEffect(() => controller.subscribe(() => setSnapshot(controller.getSnapshot())), [controller]);
		  const reload = React16.useCallback(async () => {
		    try {
		  ...
		  const saveGate = React16.useCallback(async (patch) => {
		    try {
		  ...
		  const connect = React16.useCallback(async (source) => {
		    try {
		  ...
		  let body;
		  if (screen.name === "sql") {
		    body = React16.createElement(SqlDatabaseView, {
		      api,
		    ...
		    body = React16.createElement(RedisDatabaseView, {
		      api,
		      source: screen.source,
		    ...
		    body = React16.createElement(Empty, { message: t("common.loading") });
		  } else {
		    body = React16.createElement(SourceListView, {
		      api,
		      sources,
		      settings,
		      engines,
		    ...
		    try {
		      return container.inject(
		        ...
		        () => container.register(
		          ...
		          (props) => React17.createElement("span", {
		    ...
		    try {
		      return container.inject(
		        ...
		        () => container.register(
		          ...
		          () => React17.createElement(PanelHost, { controller, api, localeListeners, onClose: close })
		        )
		      );
		    } catch (failure) {
		...
		function PanelHost(props) {
		  ...
		  const [localeTick, setLocaleTick] = React17.useState(0);
		  React17.useEffect(() => {
		  ...
		  return React17.createElement(DatabasePanel, { controller, api, localeTick, onClose });
		}
