window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function CreateTableDialog(props) {
		  ...
		  const typeList = TYPES2[kind] ?? TYPES2.mysql;
		  ...
		  const rowFor = (column, index) => {
		    ...
		    const autoHint = autoBlocker === void 0 ? null : autoBlocker === "notKey" ? t("createTable.autoNeedsKey") : autoBlocker === "notInteger" ? t("createTable.autoNeedsInteger", { name: column.name.trim() === "" ? t("createTable.thisColumn") : column.name.trim() }) : t("createTable.autoNeedsNumeric", { name: column.name.trim() === "" ? t("createTable.thisColumn") : column.name.trim() });
		    return React13.createElement(
		      "tr",
		      ...
		      React13.createElement("td", null, React13.createElement("input", {
		        ...
		        spellcheck: false,
		        onChange: (event) => patch(column.id, { defaultValue: event.target.value })
		      })),
		      /*
