window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var zh = {
		  ...
		  "browse.copy": "\u590D\u5236",
		  "browse.copyHint": "\u628A\u8FD9\u4E00\u884C\u7684\u503C\u586B\u8FDB\u300C\u63D2\u5165\u300D\u8868\u5355\uFF1A\u81EA\u589E\u5217\u7559\u7A7A\uFF0C\u7531\u6570\u636E\u5E93\u751F\u6210",
		  "browse.copiedToInsert": "\u5DF2\u590D\u5236\u5230\u63D2\u5165\u8868\u5355\uFF0C\u81EA\u589E\u5217\u7559\u7A7A\uFF0C\u786E\u8BA4\u540E\u63D0\u4EA4",
		  "browse.copiedToInsertSkipped": "\u5DF2\u590D\u5236\u5230\u63D2\u5165\u8868\u5355\uFF0C\u81EA\u589E\u5217\u7559\u7A7A\uFF1B\u5217 {columns} \u7684\u503C\u65E0\u6CD5\u590D\u5236\uFF0C\u5DF2\u7559\u7A7A",
		  "browse.editRow": "\u7F16\u8F91",
		  "browse.deleteRow": "\u5220\u9664",
		  ...
		  "browse.filtered": "\u5DF2\u5E94\u7528 {n} \u4E2A\u7B5B\u9009\u6761\u4EF6\uFF1A",
		  "browse.clearFilters": "\u6E05\u9664\u7B5B\u9009\u6761\u4EF6",
		  "structure.columns": "\u5217",
		  ...
		  "structure.typeCustomMark": "\uFF08\u81EA\u5B9A\u4E49\uFF09",
		  "structure.typeText": "\u7C7B\u578B\u6587\u672C",
		  "structure.typeEditableHint": "\u53EF\u76F4\u63A5\u7F16\u8F91\uFF1B\u4E0A\u9762\u9009\u4E00\u4E2A\u5E38\u89C1\u7C7B\u578B\u4F1A\u586B\u5165\u6B64\u5904",
		  "structure.colLength": "\u957F\u5EA6/\u503C",
		  "structure.lengthHint": "\u5199\u5728\u7C7B\u578B\u62EC\u53F7\u91CC\uFF0C\u5982 191\u300110,2\uFF1B\u7559\u7A7A\u5219\u4E0D\u5199\u62EC\u53F7",
		  "structure.sqliteLengthHint": "SQLite \u4F1A\u628A\u957F\u5EA6\u5B58\u8FDB\u7C7B\u578B\u540D\u4F46\u4E0D\u5F3A\u5236\uFF1B\u76F4\u63A5\u5199\u5728\u7C7B\u578B\u91CC\u66F4\u5E38\u89C1\uFF0C\u5982 VARCHAR(191)",
		  "structure.lengthRequired": "\u7C7B\u578B\u300C{type}\u300D\u5FC5\u987B\u7ED9\u51FA\u957F\u5EA6/\u503C\uFF0C\u8BF7\u586B\u5199\u300C{column}\u300D\u7684\u957F\u5EA6",
		  "structure.typeRequired": "\u8BF7\u4E3A\u300C{column}\u300D\u9009\u62E9\u6216\u586B\u5199\u7C7B\u578B",
		  "structure.lengthInvalid": "\u5217\u300C{column}\u300D\u7684\u957F\u5EA6/\u503C\u4E0D\u5408\u6CD5\uFF1A\u53EA\u80FD\u586B\u6570\u5B57\uFF08\u5982 255\u300110,2\uFF09\u6216\u5E26\u5F15\u53F7\u7684\u503C\u5217\u8868\uFF08\u5982 'a','b'\uFF09",
		  "structure.lengthRenamesType": "\u300C{type}\u300D\u4E0D\u80FD\u5E26\u957F\u5EA6\uFF1AMySQL \u4F1A\u628A {type}(n) \u6084\u6084\u6362\u6210\u53E6\u4E00\u4E2A\u7C7B\u578B\uFF08TEXT\u2192tinytext\u3001BLOB\u2192tinyblob\uFF09\uFF0C\u5217\u300C{column}\u300D\u7684\u957F\u5EA6\u8BF7\u7559\u7A7A",
		  "structure.sqliteNoLength": "SQLite \u4E0D\u63A5\u53D7\u5355\u72EC\u7684\u957F\u5EA6\u5B57\u6BB5\uFF1B\u8BF7\u628A\u957F\u5EA6\u5199\u8FDB\u7C7B\u578B\u91CC\uFF0C\u5982 VARCHAR(191)",
		  "structure.colCollate": "\u6392\u5E8F\u89C4\u5219",
		  "structure.colAttributes": "\u5C5E\u6027",
		  "structure.attributesHint": "\u53EF\u591A\u9009\uFF1B\u6309\u7C7B\u578B\u53EF\u7528\u7684\u9879\u624D\u4F1A\u751F\u6548",
		  "structure.attributeUnavailable": "\u5F53\u524D\u7C7B\u578B\u4E0D\u9002\u7528",
		  "structure.attributesSqlite": "SQLite \u6CA1\u6709\u5217\u5C5E\u6027",
		  "structure.attributesClear": "\u6E05\u9664\u5168\u90E8",
		  "structure.colIndex": "\u7D22\u5F15",
		  "structure.indexNameInline": "\u7D22\u5F15\u540D",
		  "structure.indexNameInlineHint": "\u7559\u7A7A\u5219\u81EA\u52A8\u547D\u540D\uFF1B\u5217\u540D\u76F8\u540C\u65F6\u7528\u4E8E\u8054\u5408\u7D22\u5F15",
		  "structure.colAuto": "\u81EA\u589E",
		  "structure.autoHint": "\u81EA\u589E\u5217\u5FC5\u987B\u662F\u4E3B\u952E\uFF0C\u6216\u81F3\u5C11\u88AB\u67D0\u4E2A\u7D22\u5F15\u8986\u76D6",
		  "structure.autoNeedsKey": "\u81EA\u589E\u9700\u8981\u8FD9\u4E00\u5217\u6210\u4E3A\u4E3B\u952E\uFF08\u6216\u5148\u7ED9\u5B83\u5EFA\u4E00\u4E2A\u7D22\u5F15\uFF09",
		  "structure.autoNeedsNumeric": "\u81EA\u589E\u53EA\u80FD\u7528\u4E8E\u6570\u5B57\u7C7B\u578B",
		  "structure.autoNeedsInteger": "SQLite \u7684\u81EA\u589E\u53EA\u80FD\u5728 INTEGER \u4E3B\u952E\u4E0A\u4F7F\u7528",
		  "structure.autoAlreadyTaken": "\u81EA\u589E\u5DF2\u88AB\u5217\u300C{name}\u300D\u5360\u7528\uFF0C\u4E00\u5F20\u8868\u53EA\u80FD\u6709\u4E00\u4E2A",
		  "structure.positionAfter": "\u653E\u5728",
		  "structure.positionEnd": "\u6700\u540E\uFF08\u9ED8\u8BA4\uFF09",
		  "structure.positionFirst": "\u6700\u524D\u9762",
		  "structure.positionAfterHint": "\u65B0\u5217\u63D2\u5165\u5230\u6240\u9009\u5217\u4E4B\u540E\uFF1B\u9009\u300C\u6700\u540E\u300D\u4E0E\u4E0D\u6307\u5B9A\u7B49\u4EF7",
		  "structure.positionUnsupported": "SQLite \u7684 ADD COLUMN \u53EA\u80FD\u52A0\u5728\u6700\u540E\uFF1A\u6307\u5B9A\u4F4D\u7F6E\u4F1A\u88AB\u5B83\u5F53\u4F5C\u7C7B\u578B\u540D\u7684\u4E00\u90E8\u5206\u9759\u9ED8\u63A5\u53D7\uFF0C\u6240\u4EE5\u8FD9\u91CC\u7981\u7528",
		  "structure.nullableKeyHint": "\u4E3B\u952E\u5217\u4E0D\u80FD\u4E3A\u7A7A\uFF0C\u6B64\u9879\u5DF2\u7981\u7528",
		  "structure.addNotNullOnSqlite": "SQLite \u4E0D\u80FD\u5F80\u5DF2\u6709\u6570\u636E\u7684\u8868\u91CC\u52A0 NOT NULL \u4E14\u65E0\u9ED8\u8BA4\u503C\u7684\u5217\uFF08\u5F15\u64CE\u539F\u6587\uFF1ACannot add a NOT NULL column with default value NULL\uFF09\u3002\u8BF7\u586B\u4E00\u4E2A\u9ED8\u8BA4\u503C\uFF0C\u6216\u52FE\u9009\u300C\u5141\u8BB8\u7A7A\u300D\u3002",
		  "structure.addNotNullOnMysql": "\u8BE5\u8868\u5DF2\u6709\u6570\u636E\uFF0CMySQL \u4F1A\u4E3A\u65E2\u6709\u884C\u586B\u5165\u9690\u5F0F\u9ED8\u8BA4\u503C\uFF08\u6570\u5B57 0\u3001\u5B57\u7B26\u4E32\u7A7A\u4E32\uFF09\u3002\u786E\u8BA4\u65E0\u8BEF\u518D\u63D0\u4EA4\u3002",
		  ...
		  "search.jumpedWith": "\u5DF2\u6309 {n} \u4E2A\u6761\u4EF6\u7B5B\u9009\uFF0C\u7ED3\u679C\u5728\u6D4F\u89C8\u6807\u7B7E\u9875",
		  "search.jumpedAll": "\u672A\u8BBE\u7F6E\u6761\u4EF6\uFF0C\u5DF2\u5728\u6D4F\u89C8\u6807\u7B7E\u9875\u663E\u793A\u5168\u90E8\u884C",
		  "search.reset": "\u6E05\u7A7A\u6761\u4EF6",
		  "search.run": "\u6267\u884C",
		  ...
		  "sql.truncated": "\u7ED3\u679C\u5DF2\u622A\u65AD",
		  "sql.resultShownInBrowse": "\u5DF2\u5207\u6362\u5230\u6D4F\u89C8\u6807\u7B7E\u9875\u663E\u793A {n} \u884C\u7ED3\u679C",
		  "sql.rerun": "\u53EF\u76F4\u63A5\u5728\u6D4F\u89C8\u9875\u7FFB\u9875\u3001\u6392\u5E8F",
		  "sql.resultFrom": "SQL \u67E5\u8BE2\u7ED3\u679C\uFF1A{n} \u884C\uFF08{schema}\uFF09",
		  "sql.showTable": "\u8FD4\u56DE\u8868 {table}",
		  "sql.noColumns": "\u8BE5\u8BED\u53E5\u6CA1\u6709\u8FD4\u56DE\u7ED3\u679C\u96C6",
		  "edit.title": "\u7F16\u8F91\u884C",
		  "edit.submit": "\u4FDD\u5B58",
		  "edit.delete": "\u5220\u9664\u6B64\u884C",
		  "edit.done": "\u5DF2\u66F4\u65B0 {n} \u884C",
		  ...
		  "redisdb.indexBuilding": "\u7D22\u5F15\u6784\u5EFA\u4E2D\uFF1A\u5DF2\u626B\u63CF {scanned} / {total}\uFF0C\u6B64\u5C42\u7684\u76EE\u5F55\u4E0E\u8BA1\u6570\u4F1A\u968F\u8FDB\u5EA6\u8865\u9F50\u3002",
		...
		var en = {
		  ...
		  "browse.copy": "Copy",
		  "browse.copyHint": "Fill the Insert form with this row: auto-assigned columns are left blank for the database to generate",
		  "browse.copiedToInsert": "Copied into the insert form with auto-assigned columns left blank; review and submit",
		  "browse.copiedToInsertSkipped": "Copied into the insert form with auto-assigned columns left blank; the values of {columns} could not be copied and were left blank",
		  "browse.editRow": "Edit",
		  ...
		  "browse.filtered": "{n} filter condition(s) applied:",
		  ...
		  "structure.typeCustomMark": "(custom)",
		  "structure.typeText": "Type text",
		  "structure.typeEditableHint": "Editable directly; picking a common type above fills it in",
		  "structure.colLength": "Length/values",
		  "structure.lengthHint": "Goes inside the type brackets: 191, 10,2. Blank adds no brackets.",
		  "structure.sqliteLengthHint": "SQLite stores a length in the type name but never enforces it; writing it into the type is the usual form, e.g. VARCHAR(191)",
		  "structure.lengthRequired": "The type \u201C{type}\u201D needs a length or value list \u2014 fill in \u201C{column}\u201D",
		  "structure.typeRequired": "Choose or type a type for \u201C{column}\u201D",
		  "structure.lengthInvalid": "The length/values for \u201C{column}\u201D are not valid: use digits (255, 10,2) or a quoted list of values ('a','b')",
		  "structure.lengthRenamesType": "\u201C{type}\u201D cannot take a length: MySQL silently turns {type}(n) into another type (TEXT\u2192tinytext, BLOB\u2192tinyblob). Leave \u201C{column}\u201D\u2019s length blank.",
		  "structure.sqliteNoLength": "SQLite has no separate length field; write the length into the type instead, e.g. VARCHAR(191)",
		  "structure.colCollate": "Collation",
		  "structure.colAttributes": "Attributes",
		  "structure.attributesHint": "Pick any that apply; only the ones the current type accepts take effect",
		  "structure.attributeUnavailable": "not for this type",
		  "structure.attributesSqlite": "SQLite has no column attributes",
		  "structure.attributesClear": "Clear all",
		  "structure.colIndex": "Index",
		  "structure.indexNameInline": "Index name",
		  "structure.indexNameInlineHint": "Blank picks a name automatically; a shared name makes a composite index",
		  "structure.colAuto": "Auto increment",
		  "structure.autoHint": "An auto-increment column must be the primary key, or at least covered by an index",
		  "structure.autoNeedsKey": "Auto increment needs this column to be the primary key (or to have an index of its own first)",
		  "structure.autoNeedsNumeric": "Auto increment only applies to numeric types",
		  "structure.autoNeedsInteger": "On SQLite, auto increment only works on an INTEGER primary key",
		  "structure.autoAlreadyTaken": "Auto increment is taken by \u201C{name}\u201D: a table has exactly one",
		  "structure.positionAfter": "Position",
		  "structure.positionEnd": "Last (default)",
		  "structure.positionFirst": "First",
		  "structure.positionAfterHint": "The new column goes right after the column you pick; \u201Clast\u201D is the same as not choosing",
		  "structure.positionUnsupported": "SQLite can only append a column with ADD COLUMN: a position clause is silently folded into the type name there, so this is disabled",
		  "structure.nullableKeyHint": "A key column cannot be nullable, so this is disabled",
		  "structure.addNotNullOnSqlite": "SQLite cannot add a NOT NULL column with no default to a table that already holds rows (the engine says: Cannot add a NOT NULL column with default value NULL). Give it a default, or tick \u5141\u8BB8\u7A7A.",
		  "structure.addNotNullOnMysql": "This table already holds rows, so MySQL fills the existing ones with the implicit default (0 for numbers, empty string for text). Submit once you are happy with that.",
		  ...
		  "search.jumpedWith": "Filtered by {n} condition(s); the result is in the Browse tab",
		  "search.jumpedAll": "No conditions set; showing every row in the Browse tab",
		  ...
		  "sql.resultShownInBrowse": "Showing {n} row(s) in the Browse tab",
		  "sql.rerun": "page and sort them there",
		  "sql.resultFrom": "SQL result: {n} row(s) ({schema})",
		  "sql.showTable": "Back to table {table}",
		  "sql.noColumns": "This statement returned no result set",
		  "edit.title": "Edit row",
		  "edit.submit": "Save",
		  ...
		  "redisdb.indexBuilding": "Building the index: {scanned} / {total} scanned. This level\u2019s folders and counts fill in as the walk proceeds.",
		...
		function Modal(props) {
		  ...
		  return React.createElement(
		    ...
		    React.createElement(
		       ...
		       */
		      props.error === void 0 ? null : React.createElement(ErrorBanner, { message: props.error }),
		...
		var COLUMNS = ["kind", "name", "host", "user", "group", "auth", "tags", "actions"];
		...
		function SourceListView(props) {
		  ...
		  for (const group of grouped) {
		    ...
		    for (const source of group.items) {
		      ...
		      const cellOf = (column) => {
		        if (column === "kind") return React7.createElement("span", { className: `dbm-badge dbm-badge-${source.kind}` }, source.kind);
		        if (column === "name") {
		          return [
		            React7.createElement("div", { key: "n", style: { fontWeight: 500 } }, source.name),
		            source.description === "" ? null : React7.createElement("div", { key: "d", className: "dbm-hint" }, source.description),
		            React7.createElement("div", { key: "i", className: "dbm-hint dbm-mono" }, source.id)
		          ];
		        }
		        if (column === "host") return React7.createElement("span", { className: "dbm-mono" }, hostOf(source));
		        ...
		        if (column === "auth") {
		          return [
		            authOf(source),
		            source.readonly ? React7.createElement("span", { key: "ro", className: "dbm-badge", style: { marginLeft: 6 } }, t("form.readonly")) : null
		          ];
		        }
		        if (column === "tags") {
		          return source.tags.length === 0 ? t("common.none") : React7.createElement(
		            "span",
		            { className: "dbm-tags" },
		        ...
		        return [
		          React7.createElement(
		            ...
		            React7.createElement(
		              "button",
		              { key: "test", type: "button", className: "dbm-btn dbm-btn-sm", disabled: test?.status === "running", onClick: () => {
		                void runTest(source);
		              } },
		            ...
		            React7.createElement("button", { key: "edit", type: "button", className: "dbm-btn dbm-btn-sm", onClick: () => setEditing(source) }, t("action.edit")),
		            React7.createElement("button", { key: "delete", type: "button", className: "dbm-btn dbm-btn-sm dbm-btn-danger", onClick: () => setDeleting(source) }, t("action.delete"))
		          ),
		      ...
		      rows.push(
		        React7.createElement(
		          ...
		          ...COLUMNS.map((column) => React7.createElement("td", { key: column }, cellOf(column)))
		        )
		      );
		    }
		  }
		      ...
		      sources.length === 0 ? React7.createElement(Empty, { message: t("list.empty") }) : filtered.length === 0 ? React7.createElement(Empty, { message: t("list.emptyFiltered") }) : React7.createElement(
		        ...
		        React7.createElement(
		          ...
		          React7.createElement(
		            "tr",
		            null,
		            ...COLUMNS.map((column) => React7.createElement("th", { key: column }, headingOf(column)))
		          )
		        ),
		...
		function prefillForm(engine, columns, row) {
		  const out = {};
		  const skipped = [];
		  for (const column of columns) {
		    ...
		    if (kind.kind === "boolean") {
		      const mapped = value === true || text === "1" ? "1" : value === false || text === "0" ? "0" : void 0;
		      if (mapped === void 0) skipped.push(column.name);
		    ...
		    if (kind.kind === "date" || kind.kind === "datetime" || kind.kind === "time") {
		      ...
		      if (controlText === void 0) skipped.push(column.name);
		...
		function controlShape(kind, text) {
		  if (kind === "date") return /^(\d{4}-\d{2}-\d{2})(?:[ T]|$)/.exec(text)?.[1];
		  const clock = /(?:^|[ T])(\d{1,2}):(\d{2})(?::(\d{2})(\.\d+)?)?$/.exec(text);
		  if (clock === null) return void 0;
		  const normalized = `${clock[1].padStart(2, "0")}:${clock[2]}${clock[3] === void 0 ? "" : `:${clock[3]}${clock[4] ?? ""}`}`;
		  if (kind === "time") return normalized;
		  const day = /^(\d{4}-\d{2}-\d{2})(?:[ T]|$)/.exec(text)?.[1];
		  return day === void 0 ? void 0 : `${day}T${normalized}`;
		}
		...
		function SqlBrowseTab(props) {
		  const { api, sourceId, engineKind, schema, table, rows, query: query2, onQuery, onReload, onExport, onImport, onCopyRow, onNotice, onError } = props;
		  ...
		  for (const column of page?.columns ?? []) {
		    ...
		    header.push(
		      React8.createElement(
		         ...
		         */
		        column.comment === void 0 || column.comment === "" ? null : React8.createElement(
		          "div",
		  ...
		  const filterBar = query2.filters === void 0 || query2.filters.length === 0 ? null : React8.createElement(
		    "div",
		    { className: "dbm-batch-bar", "data-dbm-browse-filters": "" },
		    React8.createElement("span", null, t("browse.filtered", { n: query2.filters.length })),
		    ...query2.filters.map((filter) => React8.createElement(
		      "span",
		      { key: filter.column, className: "dbm-hint dbm-mono" },
		      `${filter.column} ${t(`search.op.${filter.operator}`)}${filter.value === void 0 ? "" : ` ${filter.value}`}`
		    )),
		    ...
		    React8.createElement("button", {
		      ...
		      onClick: () => onQuery({ page: 1, filters: void 0, filterJoin: void 0 })
		  ...
		  const pager = React8.createElement(
		     ...
		     */
		    page?.comment === void 0 || page.comment === "" ? null : [
		      React8.createElement("span", { key: "gap", className: "dbm-spacer" }),
		      React8.createElement(
		        "span",
		...
		var SILENTLY_RENAMED_BY_LENGTH = /^(TEXT|BLOB)$/;
		function lengthRenamesType(type) {
		...
		function attributeAllowed(attribute, type) {
		...
		// src/client/column-spec-form.ts
		var MYSQL_MODIFIERS = ["unsigned", "zerofill"];
		function splitTypeParts(type) {
		  ...
		  while (words.length > 1 && MYSQL_MODIFIERS.includes(words[words.length - 1].toLowerCase())) {
		    const modifier = words.pop().toLowerCase();
		...
		function joinTypeParts(parts) {
		  const base = parts.base.trim();
		  const length = parts.length.trim();
		  const modifiers = parts.attributes.filter((id) => MYSQL_MODIFIERS.includes(id));
		  const suffix = modifiers.length === 0 ? "" : ` ${modifiers.join(" ")}`;
		  if (base === "") return "";
		  if (length === "" || base.includes("(")) return `${base}${suffix}`;
		  return `${base}(${length})${suffix}`;
		}
		function attributesFromColumn(column) {
		  const collected = [...splitTypeParts(column.type).attributes];
		  if (column.extra !== void 0 && /on update current_timestamp/i.test(column.extra)) {
		    collected.push("onUpdateCurrentTimestamp");
		  }
		  return collected;
		}

		// src/client/column-index-plan.ts
		function indexChoiceOf(column, indexes) {
		  if (column.key === "PRI") return "primary";
		  const unique = indexes.find((index) => index.unique === true && index.primary !== true && index.columns.length === 1 && index.columns[0] === column.name);
		  if (unique !== void 0) return "unique";
		  const plain = indexes.find((index) => index.unique !== true && index.primary !== true && index.columns.length === 1 && index.columns[0] === column.name);
		  return plain === void 0 ? "" : "index";
		}
		function backingIndex(column, indexes) {
		  return indexes.find((index) => index.primary !== true && index.columns.length === 1 && index.columns[0] === column.name);
		}
		function planIndexChange(options) {
		  ...
		  if (from === "primary" && to !== "primary") {
		    ...
		    if (backing !== void 0 && !backing.name.startsWith("sqlite_autoindex_")) {
		  ...
		  if (to === "primary") operations.push({ op: "setPrimaryKey", columns: [columnName] });
		    ...
		    const resolved = name === "" ? generatedIndexName(columnName, to, indexes) : name;
		    operations.push({ op: "createIndex", name: resolved, columns: [columnName], unique: to === "unique" });
		  }
		  return operations;
		}
		function generatedIndexName(column, kind, indexes) {
		...
		function typeGroupsFor(kind) {
		  return TYPE_GROUPS[kind] ?? TYPE_GROUPS.mysql;
		}
		function offeredTypes(kind) {
		...
		function collationsFor(kind) {
		  return COLLATIONS2[kind] ?? COLLATIONS2.mysql;
		}
		...
		function SqlStructureTab(props) {
		  ...
		  const [editorError, setEditorError] = React12.useState(void 0);
		  ...
		  const [formError, setFormError] = React12.useState(void 0);
		  ...
		  const run = async (body, options = {}) => {
		    ...
		    try {
		      ...
		      setConfirming(void 0);
		      if (options.keepEditor !== true) setEditor(void 0);
		      setIndexForm(void 0);
		      setKeyEditor(void 0);
		  ...
		  const runOnPage = async (body, options = {}) => {
		  ...
		  const draftFrom = (column) => {
		    ...
		    return {
		      ...
		      autoIncrement: column.extra !== void 0 && /auto_increment/i.test(column.extra),
		  ...
		  const sqliteAddRefused = (draft) => kind === "sqlite" && !draft.nullable && defaultToWire(editor?.default.mode ?? "none", editor?.default.text ?? "") === void 0;
		  const submitEditor = async () => {
		    ...
		    const existing = columns.find((column2) => column2.name === editor.original);
		    ...
		    if (type === "") {
		      refuse(t("structure.typeRequired", { column: name }));
		      return;
		    }
		    ...
		    const plan = editor.mode === "edit" ? planIndexChange({
		      columnName: name,
		    ...
		    if (editor.mode === "add") {
		      ...
		      if (!added.ok) {
		        refuse(t("db.action.failed", { error: added.error }));
		        return;
		      }
		    ...
		    if (!altered.ok) {
		      refuse(t("db.action.failed", { error: altered.error }));
		      return;
		    }
		    await runIndexPlan(plan, refuse);
		  };
		  const runIndexPlan = async (plan, refuse) => {
		    for (const operation of plan) {
		      const outcome = operation.op === "setPrimaryKey" ? await run({ action: "setPrimaryKey", columns: operation.columns }, { keepEditor: true }) : operation.op === "dropIndex" ? await run({ action: "dropIndex", name: operation.name }, { rows: false, keepEditor: true }) : await run(
		        { action: "createIndex", index: { name: operation.name, columns: operation.columns, unique: operation.unique } },
		        { rows: false, keepEditor: true }
		      );
		      if (!outcome.ok) {
		        refuse(t("db.action.failed", { error: outcome.error }));
		        return;
		      }
		    }
		    setEditor(void 0);
		  ...
		  const header = React12.createElement(
		    ...
		    ].map((label, index, all) => React12.createElement(
		      "th",
		      {
		        key: label,
		        /*
		  ...
		  const indexHeader = React12.createElement(
		    "tr",
		    null,
		    ...[t("structure.index.name"), t("structure.index.unique"), t("structure.index.columns"), t("structure.index.type"), t("structure.index.actions")].map((label, index, all) => React12.createElement(
		      "th",
		  ...
		  return React12.createElement(
		    ...
		    React12.createElement(
		      ...
		      indexForm === void 0 ? null : React12.createElement(IndexCreator, {
		        ...
		        indexes,
		        busy,
		        ...formError === void 0 ? {} : { error: formError },
		        onChange: (next) => {
		          setFormError(void 0);
		          setIndexForm(next);
		        },
		        onSubmit: () => {
		          ...
		          if (name === "") {
		            setFormError(t("structure.indexNameRequired"));
		            return;
		          }
		          ...
		          if (indexForm.columns.length === 0) {
		            setFormError(t("structure.noColumnsSelected"));
		            return;
		          }
		          void (async () => {
		    ...
		    confirming === void 0 ? null : React12.createElement(ConfirmChange, {
		      ...
		      onConfirm: () => {
		        if (confirming.op === "dropIndex") {
		          void runOnPage({ action: "dropIndex", name: confirming.name }, { rows: false });
		          return;
		        }
		        if (confirming.op === "dropColumn") {
		          void runOnPage({ action: "dropColumn", column: confirming.column });
		          return;
		        }
		        void (async () => {
		          for (const column of confirming.columns) {
		            ...
		            if (!outcome.ok) {
		              onError(t("db.action.failed", { error: outcome.error }));
		              return;
		            }
		          }
		          setSelected(/* @__PURE__ */ new Set());
		...
		function ColumnEditor(props) {
		  ...
		  const keyed = editor.mode === "edit" && existing?.primaryKeyPosition !== void 0;
		  const patch = (next) => onChange({ draft: { ...draft, ...next } });
		  const patchDefault = (next) => onChange({ default: { ...defaultDraft, ...next } });
		  const typeCell = () => {
		    if (draft.typeCustom) {
		      return React12.createElement(
		        "div",
		    ...
		    return React12.createElement(
		      ...
		      [
		        ...groups.map((group) => React12.createElement(
		          "optgroup",
		          { key: group.label, label: t(group.label) },
		          ...group.types.map((value) => React12.createElement("option", { key: value, value }, value))
		        )),
		        ...
		        isListed ? null : React12.createElement("option", { key: "__customValue__", value: "__customValue__" }, `${draft.type} ${t("structure.typeCustomMark")}`),
		        React12.createElement("option", { key: "__custom__", value: "__custom__" }, t("createTable.typeCustom"))
		  ...
		  const attributeControl = () => {
		    ...
		    return React12.createElement(
		      ...
		      [
		        React12.createElement("option", { key: "__summary__", value: "" }, isSqlite ? t("structure.attributesSqlite") : summary),
		        ...ATTRIBUTE_ITEMS.map((item) => {
		          ...
		          return React12.createElement(
		            ...
		            available ? `${chosen.includes(item.id) ? "\u2713 " : ""}${item.label}` : `${item.label} \u2014 ${t("structure.attributeUnavailable")}`
		          );
		        }),
		        chosen.length === 0 ? null : React12.createElement("option", { key: "__clear__", value: "__clear__" }, t("structure.attributesClear"))
		      ].filter((entry) => entry !== null)
		    );
		  };
		  const indexControl = () => React12.createElement(
		    "select",
		    {
		      className: "dbm-select",
		      value: draft.index,
		    ...
		    [
		      React12.createElement("option", { key: "", value: "" }, t("common.none")),
		      ...["primary", "unique", "index"].map((value) => React12.createElement("option", { key: value, value }, t(`createTable.index.${value}`)))
		    ]
		  );
		  const defaultControl = () => {
		    ...
		    return React12.createElement(
		      ...
		      ...DEFAULT_MODES.map((mode) => {
		        ...
		        const unavailable = mode === "currentTimestamp" && !supportsCurrentTimestamp(joinTypeParts({ base: draft.type, length: "", attributes: [] }));
		        return React12.createElement(
		          "option",
		  ...
		  const autoHint = autoBlocked === void 0 ? t("structure.autoHint") : autoBlocked === "notKey" ? t("structure.autoNeedsKey") : autoBlocked === "notInteger" ? t("structure.autoNeedsInteger") : t("structure.autoNeedsNumeric");
		  ...
		  return React12.createElement(Modal, {
		    ...
		    children: React12.createElement(
		       ...
		       * says so.
		       */
		      field("length", t("structure.colLength"), React12.createElement("input", {
		        className: "dbm-input dbm-mono",
		        value: draft.length,
		      ...
		      field("collate", t("structure.colCollate"), React12.createElement(
		        "select",
		        {
		          className: "dbm-select",
		          value: draft.collate,
		          ...
		          onChange: (event) => patch({ collate: event.target.value })
		        },
		        collationsFor(kind).map((value) => React12.createElement("option", { key: value === "" ? "__none__" : value, value }, value === "" ? t("common.none") : value))
		      )),
		      ...
		      field("indexName", t("structure.indexNameInline"), React12.createElement("input", {
		        className: "dbm-input dbm-mono",
		        ...
		        onChange: (event) => patch({ indexName: event.target.value })
		      ...
		      field(
		        ...
		        React12.createElement(
		          ...
		          React12.createElement("input", {
		            ...
		            title: keyed ? t("structure.nullableKeyHint") : void 0,
		            onChange: (event) => patch({ nullable: event.target.checked })
		          }),
		          t("structure.col.nullable")
		        ),
		        keyed ? t("structure.nullableKeyHint") : void 0
		      ),
		      ...
		      field(
		        ...
		        React12.createElement(
		          ...
		          React12.createElement("input", {
		            ...
		            disabled: autoBlocked !== void 0 && !draft.autoIncrement,
		            "data-dbm-column-auto": "",
		            onChange: (event) => patch({ autoIncrement: event.target.checked })
		          })
		        ),
		        autoHint
		      ),
		      field("comment", t("structure.col.comment"), React12.createElement("input", {
		        ...
		        disabled: isSqlite,
		        title: isSqlite ? t("createTable.sqliteNoComment", { name: draft.name || "\u2014" }) : void 0,
		       ...
		       */
		      editor.mode === "add" ? field("position", t("structure.positionAfter"), React12.createElement(
		        "select",
		        {
		          className: "dbm-select",
		        ...
		        [
		          React12.createElement("option", { key: "", value: "" }, t("structure.positionEnd")),
		          React12.createElement("option", { key: "__first__", value: POSITION_FIRST }, t("structure.positionFirst")),
		          ...columns.map((column) => React12.createElement("option", { key: column.name, value: column.name }, column.name))
		        ]
		      ), isSqlite ? t("structure.positionUnsupported") : t("structure.positionAfterHint")) : null,
		       ...
		       */
		      editor.mode === "add" && isSqlite && !draft.nullable && defaultToWire(defaultDraft.mode, defaultDraft.text) === void 0 ? React12.createElement("div", { className: "dbm-hint", "data-dbm-column-sqlite-warning": "" }, t("structure.addNotNullOnSqlite")) : null
		    )
		  });
		}
		...
		function CreateTableDialog(props) {
		  ...
		  const isSqlite = kind === "sqlite";
		  const collationList = COLLATIONS3[kind] ?? COLLATIONS3.mysql;
		...
		function SqlDatabaseView(props) {
		  ...
		  const [sqlText, setSqlText] = React16.useState("");
		  const [sqlAllowWrite, setSqlAllowWrite] = React16.useState(false);
		  const [sqlResult, setSqlResult] = React16.useState(void 0);
		  const [transfer, setTransfer] = React16.useState(void 0);
		  const [insertPrefill, setInsertPrefill] = React16.useState(void 0);
		  const prefillNonce = React16.useRef(0);
		  ...
		  const changeTab = (next, options = {}) => {
		    setTab(next);
		    setError(void 0);
		    setNotice(void 0);
		    if (options.keepSqlResult !== true) setSqlResult(void 0);
		    if (next !== "insert") setInsertPrefill(void 0);
		    ...
		    if (next === "browse") void loadRows({
		      ...
		      mode: "browse",
		      ...layout.orderBy === void 0 ? {} : { orderBy: layout.orderBy },
		      ...layout.orderByColumns === void 0 ? {} : { orderByColumns: layout.orderByColumns },
		      ...layout.filters === void 0 ? {} : { filters: layout.filters },
		      ...layout.filterJoin === void 0 ? {} : { filterJoin: layout.filterJoin },
		      ...
		      if (sqlResult !== void 0) {
		        body.push(
		          React16.createElement(
		            ...
		            React16.createElement(
		              "div",
		              { className: "dbm-row", style: { padding: "8px 12px" } },
		              React16.createElement("span", { className: "dbm-hint" }, t("sql.resultFrom", { schema: activeSchema ?? "", n: sqlResult.result.rows.length })),
		            ...
		            React16.createElement("div", { className: "dbm-pad dbm-hint dbm-mono", style: { paddingTop: 0 } }, sqlResult.sql),
		            React16.createElement(SqlResultGrid, { result: sqlResult.result })
		          )
		        );
		      } else {
		        body.push(React16.createElement(SqlBrowseTab, {
		          ...
		          onCopyRow: (prefill) => {
		            ...
		            changeTab("insert");
		            setNotice(prefill.skipped.length === 0 ? t("browse.copiedToInsert") : t("browse.copiedToInsertSkipped", { columns: prefill.skipped.join("\u3001") }));
		          },
		          onNotice: (message) => {
		            setNotice(message);
		      ...
		      body.push(
		        React16.createElement(SqlTabView, {
		          ...
		          onSelect: (ranSql, result) => {
		            ...
		            setNotice(`${t("sql.resultShownInBrowse", { n: result.rows.length })} \xB7 ${t("sql.rerun")}`);
		          },
		          onResult: (message) => {
		            setNotice(message);
		            setError(void 0);
		        ...
		        React16.createElement(SqlSearchTab, {
		          ...
		          onSearch: (filters) => {
		            const next = {
		              ...
		              orderBy: void 0,
		              orderByColumns: void 0,
		              ...filters.length === 0 ? { filters: void 0, filterJoin: void 0 } : { filters, filterJoin: "and" }
		            };
		            setBrowse(next);
		            changeTab("browse", { browse: next });
		            setNotice(filters.length === 0 ? t("search.jumpedAll") : t("search.jumpedWith", { n: filters.length }));
		          },
		          onError: (message) => {
		            setError(message);
		            if (message !== void 0) setNotice(void 0);
		    ...
		    if (tab === "insert") {
		      body.push(
		        React16.createElement(SqlInsertTab, {
		          ...
		          ...insertPrefill === void 0 ? {} : { prefill: insertPrefill },
		          /*
		...
		function SqlResultGrid(props) {
		  const { result } = props;
		  if (result.columns.length === 0) {
		    return React16.createElement("div", { className: "dbm-pad dbm-hint" }, t("sql.noColumns"));
		  }
		  return React16.createElement(
		    "div",
		    ...
		    React16.createElement(
		      ...
		      React16.createElement(
		        "thead",
		        null,
		        React16.createElement("tr", null, ...result.columns.map((column) => React16.createElement("th", { key: column }, column)))
		      ),
		      React16.createElement(
		        "tbody",
		        null,
		...
		function SqlTabView(props) {
		  ...
		  const [message, setMessage] = React16.useState(void 0);
		  ...
		  const run = async () => {
		    ...
		    try {
		      ...
		      if (value.write) {
		        ...
		        const text = `${t("sql.rows", { n: value.rows.length, ms: value.durationMs })}${value.truncated ? ` \xB7 ${t("sql.truncated")}` : ""}`;
		        onSelect(sql, value);
		        onResult(text);
		      }
		    } catch (failure) {
		  ...
		  return React16.createElement(
		    ...
		    React16.createElement(
		      ...
		      React16.createElement(
		        "div",
		        { className: "dbm-row" },
		        React16.createElement("button", { type: "button", className: "dbm-btn dbm-btn-primary", disabled: busy, "data-dbm-sql-run": "", onClick: () => {
		          void run();
		        ...
		        React16.createElement(
		          ...
		          React16.createElement("input", {
		            type: "checkbox",
		            checked: allowWrite,
		            onChange: (event) => onAllowWrite(event.target.checked)
		          }),
		          t("sql.allowWrite")
		        ),
		        React16.createElement("span", { className: "dbm-hint" }, t("sql.allowWrite.hint"))
		      ),
		      message === void 0 ? null : React16.createElement("div", { className: "dbm-hint", "data-dbm-sql-message": "" }, message)
		    )
		  );
		}
