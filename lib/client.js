window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var zh = {
		  ...
		  "createTable.autoNeedsInteger": "SQLite \u7684\u81EA\u589E\u8981\u6C42\u7C7B\u578B\u4E3A INTEGER\uFF08INT \u4E0D\u662F rowid \u522B\u540D\uFF0C\u4E0D\u4F1A\u81EA\u589E\uFF09",
		...
		var en = {
		  ...
		  "createTable.autoNeedsInteger": "SQLite auto-increment requires the type INTEGER (INT is not the rowid alias and will not increment)",
		...
		function DatabaseActionDialog(props) {
		  ...
		  const submit = async () => {
		    ...
		    try {
		      ...
		      const label = action === "create" ? t("db.op.create") : action === "rename" ? t("db.op.rename") : action === "copy" ? t("db.op.copy") : action === "drop" ? t("db.op.drop") : t("db.op.charset");
		...
		function MaintenanceReportDialog(props) {
		  ...
		  return React12.createElement(Modal, {
		    ...
		    children: running ? React12.createElement(
		      ...
		      React12.createElement("span", null, t("db.maint.running", { op: t(`db.maint.${op ?? "check"}`) }))
		    ) : React12.createElement(
		      "div",
		      null,
		    ...
		    React13.createElement(
		      ...
		      React13.createElement(
		        ...
		        React13.createElement("input", {
		          ...
		          onChange: (event) => patch(column.id, {
		    ...
		    React13.createElement(
		      ...
		      React13.createElement(
		        ...
		        React13.createElement("input", {
		          ...
		          disabled: column.key,
		          title: column.key ? t("createTable.keyNotNullable") : void 0,
		    ...
		    React13.createElement(
		      ...
		      React13.createElement(
		        ...
		        React13.createElement("input", {
		          ...
		          title: column.key ? kind === "sqlite" ? t("createTable.autoNeedsInteger") : void 0 : t("createTable.autoNeedsKey"),
		  ...
		  const body = React13.createElement(
		    ...
		    React13.createElement(
		      ...
		      React13.createElement(
		        "datalist",
		        { id: `dbm-types-${kind}` },
		        ...typeList.map((value) => React13.createElement("option", { key: value, value }))
		      ),
		      React13.createElement(
		        "div",
		        { className: "dbm-scroll" },
		          ...
		          React13.createElement(
		            ...
		            React13.createElement(
		              ...
		              ...[
		                ...
		                t("createTable.columnAuto"),
		                ""
		              ].map((label, index) => React13.createElement("th", { key: `${label}-${index}` }, label))
		            )
		          ),
		...
		function SqlDatabaseView(props) {
		  ...
		  const runBatchAction = async (schema, tables, op) => {
		    ...
		    try {
		      ...
		      setNotice(failures.length === 0 ? t("db.batch.done", { n: ok, op: t(op === "truncate" ? "db.batch.truncate" : "db.batch.drop") }) : t("db.batch.partial", { ok, failed: failures.length }));
		      await loadTables(schema, true);
		      await loadStats(schema, true);
		    } finally {
		      setBatchBusy(false);
