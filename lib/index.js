...
function describeRedisError(error) {
  if (typeof error === "object" && error !== null) {
    ...
    const code = typeof record.code === "string" ? record.code : void 0;
    if (message !== void 0) return code === void 0 ? message : `${message} (${code})`;
  }
  return error instanceof Error ? error.message : String(error);
}
...
var MAX_ELEMENTS, RedisDriver, REDIS_READ_COMMANDS;
    ...
    RedisDriver = class {
      ...
      async client(db) {
        ...
        const client = new Redis(this.entry.port ?? 6379, host, {
          ...
          db: index,
          connectTimeout: this.entry.connectTimeoutMs ?? 1e4,
    ...
    SqliteDriver = class {
      ...
      async test() {
        ...
        try {
          ...
          return { ok: true, latencyMs: Date.now() - started, ...version === void 0 ? {} : { serverVersion: `SQLite ${version}` } };
        } catch (error) {
