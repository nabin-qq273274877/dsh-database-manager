...
function makeTools(store, pool, defineTool2) {
  ...
  const schemaTool = defineTool2({
    ...
    async execute(args) {
      ...
      const project = (value) => ({
        ...value,
        ...Object.hasOwn(value, "columns") ? { columns: value.columns.map(shapeColumnInfo) } : {},
        ...Object.hasOwn(value, "indexes") ? { indexes: value.indexes.map(shapeIndexInfo) } : {}
      });
      if (isRedisDriver(driver)) {
...
function shapeSource(source) {
  return {
    ...
    name: source.name,
    group: source.group,
    ...source.host === void 0 ? {} : { host: source.host },
    ...source.port === void 0 ? {} : { port: source.port },
    ...source.file === void 0 ? {} : { file: source.file },
    ...source.user === void 0 ? {} : { user: source.user },
    ...source.db === void 0 ? {} : { db: source.db },
    ...source.tls === void 0 ? {} : { tls: source.tls },
...
function shapeColumnInfo(column) {
  return {
    name: column.name,
    type: column.type,
    nullable: column.nullable,
    ...
    ...column.extra === void 0 ? {} : { extra: column.extra },
    ...column.comment === void 0 ? {} : { comment: column.comment },
    ...column.primaryKeyPosition === void 0 ? {} : { primaryKeyPosition: column.primaryKeyPosition },
    ...column.options === void 0 ? {} : { options: [...column.options] },
    ...column.generated === void 0 ? {} : { generated: column.generated },
    ...column.generatedExpression === void 0 ? {} : { generatedExpression: column.generatedExpression },
    ...column.collation === void 0 ? {} : { collation: column.collation }
  };
}
function shapeIndexInfo(index) {
  return {
    name: index.name,
    unique: index.unique,
    columns: [...index.columns],
    ...index.type === void 0 ? {} : { type: index.type },
    ...index.primary === void 0 ? {} : { primary: index.primary }
  };
}
